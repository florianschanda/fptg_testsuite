...
(define-const input_3 Float64 (fp #b0 #b10101100011 #b0011000110101101111011100011100010101011000011010001))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b0 #b10101100011 #b0011000110101101111011100011100010101011000011010001))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
