...
(define-const input_2 Float64 (fp #b1 #b10111100001 #b1111111100110101111000100011111111111001100001110010))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b0 #b00111100011 #b1111111100110101111000100011111111111001100001110010))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
