...
(define-const input_1 Float64 (fp #b1 #b10000101111 #b0001100010100010110000011111011111110100000110101111))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b1 #b10000101111 #b0001100010100010110000011111011111110100000110101111))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
