...
(define-const input_1 Float64 (fp #b0 #b11000101000 #b1110010011110011110110111100101001100011111010000001))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b0 #b11000101000 #b1110010011110011110110111100101001100011111010000001))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
