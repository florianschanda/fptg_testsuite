...
(define-const input_1 Float64 (fp #b0 #b11111000010 #b1100010011001000101000010110001011100001001001001101))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b0 #b01110110110 #b1110011000011001100110101101001001001101001010110011))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
