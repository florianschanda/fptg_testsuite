...
(define-const input_1 Float64 (fp #b0 #b01111010110 #b1100010100100111010010011010110111010000111001100001))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000111000101001))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
