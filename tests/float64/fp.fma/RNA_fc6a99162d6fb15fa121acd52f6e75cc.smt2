...
(define-const input_3 Float64 (fp #b0 #b11001110111 #b1110101110110010011100110010110101001000110111001100))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b0 #b11001110111 #b1110101110110010011100110010110101001000110111001100))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
