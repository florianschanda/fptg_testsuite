...
(define-const input_1 Float64 (fp #b1 #b10100011101 #b0110011011010000000010011101110001010010111101110111))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b0 #b10101100010 #b1110010010001011110110000110011110010000000011111110))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
