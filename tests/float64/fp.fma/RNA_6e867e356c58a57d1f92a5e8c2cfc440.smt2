...
(define-const input_1 Float64 (fp #b0 #b10011001100 #b1110010011010100000011101110010110010011010111010111))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b1 #b00000000000 #b0000100101101000110110110110101111110011111101101100))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
