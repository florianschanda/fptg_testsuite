...
(define-const input_1 Float64 (fp #b1 #b10110000101 #b1001011001101011000101100110010001011101011110010111))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b1 #b10110000101 #b1001011001101011000101100110010001011101011110010111))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
