...
(define-const input_3 Float64 (fp #b0 #b10001110010 #b0010110101010111110001000000110010001110111110011100))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b0 #b10001110010 #b0010110101010111110001000000110010001110111110011100))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
