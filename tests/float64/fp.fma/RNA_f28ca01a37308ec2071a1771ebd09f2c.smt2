...
(define-const input_3 Float64 (fp #b1 #b11111010110 #b1111100011011000100010001100011101011111101000001001))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b1 #b11111010110 #b1111100011011000100010001100011101011111101000001001))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
