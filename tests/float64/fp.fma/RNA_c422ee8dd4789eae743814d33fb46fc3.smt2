...
(define-const input_1 Float64 (fp #b1 #b10000101001 #b0010000100001011111010011000010011000011100111000001))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b0 #b00000101011 #b0010000100001011111010011000010011000011100111000000))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
