...
(define-const input_1 Float64 (fp #b0 #b11010110111 #b1111100001010010101100101111001011001010000000011101))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b0 #b01001111101 #b1010011011100101100101110001001000001100111001110111))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
