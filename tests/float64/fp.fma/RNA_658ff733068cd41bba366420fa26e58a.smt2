...
(define-const input_3 Float64 (fp #b1 #b11101011110 #b0011111000010111111010010101010000101001001111111110))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b1 #b11101011110 #b0011111000010111111010010101010000101001001111111110))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
