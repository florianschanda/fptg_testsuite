...
(define-const input_1 Float64 (fp #b0 #b10001000101 #b1100001010101010101100010111010010101010000111110101))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b1 #b00001000111 #b1100001010101010101100010111010010101010000111110011))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
