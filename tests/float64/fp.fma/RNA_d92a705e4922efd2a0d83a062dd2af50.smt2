...
(define-const input_2 Float64 (fp #b1 #b10011111001 #b1000000000011001000100000010110011010001101000110110))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b0 #b00011111011 #b1000000000011001000100000010110011010001101000110110))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
