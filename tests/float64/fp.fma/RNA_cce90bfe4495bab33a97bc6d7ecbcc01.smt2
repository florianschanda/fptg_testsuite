...
(define-const input_2 Float64 (fp #b0 #b10100100011 #b1011000101000110010100010010101010100010101001001111))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b1 #b00100100101 #b1011000101000110010100010010101010100010101001001111))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
