...
(define-const input_2 Float64 (fp #b0 #b11111110001 #b0001010111011000111111111001001000101101010001111110))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b1 #b01111110011 #b0001010111011000111111111001001000101101010001111110))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
