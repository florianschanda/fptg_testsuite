...
(define-const input_3 Float64 (fp #b0 #b01100000010 #b1011001011011010110011110001110111000001010000011110))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b0 #b01100000010 #b1011001011011010110011110001110111000001010000011110))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
