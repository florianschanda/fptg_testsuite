...
(define-const input_2 Float64 (fp #b0 #b11100010110 #b0111000000101000001010010100110111110101111010010000))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b1 #b01100011000 #b0111000000101000001010010100110111110101111010001111))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
