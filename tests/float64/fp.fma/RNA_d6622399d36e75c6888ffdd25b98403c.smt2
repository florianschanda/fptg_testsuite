...
(define-const input_1 Float64 (fp #b1 #b11011100010 #b0001110000110011000111010011010000000010000011101010))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b0 #b01011100100 #b0001110000110011000111010011010000000010000011101001))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
