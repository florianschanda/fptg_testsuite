...
(define-const input_1 Float64 (fp #b1 #b10101010111 #b1111000010111101011111000010001001110101110001110100))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b1 #b00000000000 #b1111010111100000110100111110000111101110011000010001))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
