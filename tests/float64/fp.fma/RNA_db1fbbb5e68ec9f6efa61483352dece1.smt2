...
(define-const input_1 Float64 (fp #b1 #b10100011010 #b0101101110111101101011000001100110111001001111100000))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b0 #b00100011100 #b0101101110111101101011000001100110111001001111011111))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
