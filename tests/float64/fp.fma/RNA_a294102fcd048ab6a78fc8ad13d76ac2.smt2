...
(define-const input_2 Float64 (fp #b1 #b10111110101 #b1110001000100001101100011111001010111001110101101001))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b0 #b00111110111 #b1110001000100001101100011111001010111001110101100111))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
