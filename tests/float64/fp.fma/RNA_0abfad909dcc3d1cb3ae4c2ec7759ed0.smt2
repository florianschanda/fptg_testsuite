...
(define-const input_2 Float64 (fp #b1 #b10010001000 #b1111101000110011011100001111001010110001111010101101))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b0 #b00010001010 #b1111101000110011011100001111001010110001111010101101))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
