...
(define-const input_2 Float64 (fp #b1 #b01111001101 #b0110010001001110010110101011010001000011100100011111))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b0 #b00000000001 #b0000000000000000000000000000000000000000000000000110))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
