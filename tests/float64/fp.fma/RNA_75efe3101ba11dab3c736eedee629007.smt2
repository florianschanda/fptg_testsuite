...
(define-const input_3 Float64 (fp #b0 #b00010110111 #b0001001100010010101100111011000101111101101011100110))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b0 #b00010110111 #b0001001100010010101100111011000101111101101011100110))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
