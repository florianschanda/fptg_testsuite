...
(define-const input_3 Float64 (fp #b1 #b11000100011 #b0011101111010001001110000101110000001100111110001101))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b1 #b11000100011 #b0011101111010001001110000101110000001100111110001101))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
