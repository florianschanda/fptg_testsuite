...
(define-const input_3 Float64 (fp #b1 #b10011000011 #b1101011011001010010110001010000111110101000111010010))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b1 #b10011000011 #b1101011011001010010110001010000111110101000111010010))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
