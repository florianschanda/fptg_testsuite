...
(define-const input_3 Float64 (fp #b1 #b10000000111 #b0101010010111101100010111100000001010001000101110110))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b1 #b10000000111 #b0101010010111101100010111100000001010001000101110110))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
