...
(define-const input_1 Float64 (fp #b1 #b10101010000 #b1000111001001010110011101010000000111111001011010010))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b0 #b00101100101 #b0110000000000101000110101100101011011111011010001001))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
