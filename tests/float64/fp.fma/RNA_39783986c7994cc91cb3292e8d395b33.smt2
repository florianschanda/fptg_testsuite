...
(define-const input_2 Float64 (fp #b1 #b10101011011 #b1111010000011011000011001010001100101000000000110000))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b0 #b00101011101 #b1111010000011011000011001010001100101000000000110000))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
