...
(define-const input_3 Float64 (fp #b1 #b01110101101 #b0100000110001101010001000011000111000001011010101011))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b1 #b01110101101 #b0100000110001101010001000011000111000001011010101011))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
