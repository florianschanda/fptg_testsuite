...
(define-const input_2 Float64 (fp #b1 #b11010110110 #b1111000111010101001111111011101000101001001011000110))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b0 #b01010111000 #b1111000111010101001111111011101000101001001011000100))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
