...
(define-const input_1 Float64 (fp #b1 #b10001011001 #b1011000100011100011111100111110110111100100010000010))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b0 #b00000000000 #b0111011101010111010011100111010011101110011010010001))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
