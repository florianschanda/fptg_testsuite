...
(define-const input_1 Float64 (fp #b0 #b11010000100 #b0001000011100101010111101001011010011111010100101000))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b0 #b01010000110 #b0001000011100101010111101001011010011111010100101000))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
