...
(define-const input_1 Float64 (fp #b0 #b11011011011 #b0111110000001011000010010111001010010000100101100111))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b0 #b01011011101 #b0111110000001011000010010111001010010000100101100111))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
