...
(define-const input_2 Float64 (fp #b0 #b10011111001 #b0010110010111111001011010111001100101000110110001101))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b1 #b00011111011 #b0010110010111111001011010111001100101000110110001100))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
