...
(define-const input_1 Float64 (fp #b0 #b10011100001 #b1010001101110101001011111010000000100100010111011100))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b1 #b00011100011 #b1010001101110101001011111010000000100100010111011010))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
