...
(define-const input_2 Float64 (fp #b0 #b11011000110 #b0001110000011100010010111101010011100110000101111111))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b1 #b01011001000 #b0001110000011100010010111101010011100110000101111110))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
