...
(define-const input_3 Float64 (fp #b0 #b00000110011 #b1110010010010010001100110111111011100000111001000110))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b0 #b00000110011 #b1110010010010010001100110111111011100000111001000110))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
