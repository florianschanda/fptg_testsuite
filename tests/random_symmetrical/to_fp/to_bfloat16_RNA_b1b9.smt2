...
(define-const potato (_ FloatingPoint 5 5) (fp #b0 #b00111 #b0101))
;; should be 0.005126953125
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result (_ FloatingPoint 8 8) (fp #b0 #b01110111 #b0101000))
;; should be 0.005126953125
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
