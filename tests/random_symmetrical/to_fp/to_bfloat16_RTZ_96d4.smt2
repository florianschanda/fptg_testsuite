...
(define-const potato (_ FloatingPoint 5 5) (fp #b1 #b01001 #b1101))
;; should be -0.0283203125
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result (_ FloatingPoint 8 8) (fp #b1 #b01111001 #b1101000))
;; should be -0.0283203125
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
