...
(define-const potato (_ FloatingPoint 7 7) (fp #b0 #b1100111 #b000110))
;; should be 1202590842880.0
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result (_ FloatingPoint 8 11) (fp #b0 #b10100111 #b0001100000))
;; should be 1202590842880.0
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
