...
(define-const potato (_ FloatingPoint 7 7) (fp #b0 #b0111011 #b111111))
;; should be 0.1240234375
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result (_ FloatingPoint 8 11) (fp #b0 #b01111011 #b1111110000))
;; should be 0.1240234375
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
