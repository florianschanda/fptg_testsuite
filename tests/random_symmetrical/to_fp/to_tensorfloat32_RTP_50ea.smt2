...
(define-const potato (_ FloatingPoint 7 7) (fp #b0 #b1011011 #b011001))
;; should be 373293056.0
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result (_ FloatingPoint 8 11) (fp #b0 #b10011011 #b0110010000))
;; should be 373293056.0
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
