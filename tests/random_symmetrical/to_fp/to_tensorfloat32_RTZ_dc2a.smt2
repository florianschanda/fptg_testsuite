...
(define-const potato (_ FloatingPoint 7 7) (fp #b0 #b0111000 #b110110))
;; should be 0.014404296875
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result (_ FloatingPoint 8 11) (fp #b0 #b01111000 #b1101100000))
;; should be 0.014404296875
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
