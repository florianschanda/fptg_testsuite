...
(define-const potato (_ FloatingPoint 4 10) (fp #b0 #b0111 #b010110001))
;; should be 1.345703125
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result (_ FloatingPoint 8 11) (fp #b0 #b01111111 #b0101100010))
;; should be 1.345703125
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
