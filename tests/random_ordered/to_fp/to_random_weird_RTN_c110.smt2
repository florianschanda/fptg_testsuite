...
(define-const potato (_ FloatingPoint 4 5) (fp #b1 #b0010 #b1001))
;; should be -0.048828125
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result (_ FloatingPoint 12 8) (fp #b1 #b011111111010 #b1001000))
;; should be -0.048828125
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
