...
(define-const potato (_ FloatingPoint 7 13) (fp #b1 #b0111101 #b101000001101))
;; should be -0.40704345703125
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result (_ FloatingPoint 3 3) (fp #b1 #b001 #b11))
;; should be -0.4375
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
