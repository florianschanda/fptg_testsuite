...
(define-const potato (_ FloatingPoint 6 5) (fp #b1 #b111011 #b0010))
;; should be -301989888.0
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result (_ FloatingPoint 8 11) (fp #b1 #b10011011 #b0010000000))
;; should be -301989888.0
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
