...
(define-const potato (_ FloatingPoint 6 3) (fp #b1 #b111011 #b01))
;; should be -335544320.0
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result (_ FloatingPoint 7 11) (fp #b1 #b1011011 #b0100000000))
;; should be -335544320.0
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
