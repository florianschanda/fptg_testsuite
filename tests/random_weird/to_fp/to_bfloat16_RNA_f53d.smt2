...
(define-const potato (_ FloatingPoint 6 4) (fp #b0 #b111010 #b001))
;; should be 150994944.0
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result (_ FloatingPoint 8 8) (fp #b0 #b10011010 #b0010000))
;; should be 150994944.0
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
