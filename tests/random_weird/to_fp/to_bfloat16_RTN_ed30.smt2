...
(define-const potato (_ FloatingPoint 6 4) (fp #b0 #b111100 #b110))
;; should be 939524096.0
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result (_ FloatingPoint 8 8) (fp #b0 #b10011100 #b1100000))
;; should be 939524096.0
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
