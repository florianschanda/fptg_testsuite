...
(define-const potato (_ FloatingPoint 6 5) (fp #b0 #b110111 #b1010))
;; should be 27262976.0
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result (_ FloatingPoint 8 11) (fp #b0 #b10010111 #b1010000000))
;; should be 27262976.0
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
