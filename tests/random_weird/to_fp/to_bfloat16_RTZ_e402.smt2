...
(define-const potato (_ FloatingPoint 6 4) (fp #b1 #b011001 #b001))
;; should be -0.017578125
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result (_ FloatingPoint 8 8) (fp #b1 #b01111001 #b0010000))
;; should be -0.017578125
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
