...
(define-const potato (_ FloatingPoint 6 5) (fp #b0 #b110110 #b0100))
;; should be 10485760.0
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result (_ FloatingPoint 7 9) (fp #b0 #b1010110 #b01000000))
;; should be 10485760.0
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
