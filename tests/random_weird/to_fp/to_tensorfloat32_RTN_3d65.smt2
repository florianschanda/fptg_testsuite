...
(define-const potato (_ FloatingPoint 6 5) (fp #b0 #b111001 #b1011))
;; should be 113246208.0
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result (_ FloatingPoint 8 11) (fp #b0 #b10011001 #b1011000000))
;; should be 113246208.0
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
