...
(define-const potato Float16 (fp #b1 #b01101 #b0011010100))
;; should be -0.3017578125
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result (_ FloatingPoint 8 11) (fp #b1 #b01111101 #b0011010100))
;; should be -0.3017578125
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
