...
(define-const potato Float16 (fp #b1 #b10000 #b1111101111))
;; should be -3.966796875
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result (_ FloatingPoint 10 14) (fp #b1 #b1000000000 #b1111101111000))
;; should be -3.966796875
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
