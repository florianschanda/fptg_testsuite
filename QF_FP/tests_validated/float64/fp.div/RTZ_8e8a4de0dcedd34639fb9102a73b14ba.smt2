...
(define-const input_2 Float64 (fp #b0 #b00000000000 #b0011101011001101100011111000111110010110000100110111))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b1 #b10000000001 #b0001011010100000000110000111111010010110110110111111))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
