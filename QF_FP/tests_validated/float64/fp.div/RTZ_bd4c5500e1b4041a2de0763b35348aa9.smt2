...
(define-const input_2 Float64 (fp #b0 #b00000110110 #b0010010000100100000010010011101011011101000111101011))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b1 #b01111001001 #b1100000010101001000100011001001110101000001000110111))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
