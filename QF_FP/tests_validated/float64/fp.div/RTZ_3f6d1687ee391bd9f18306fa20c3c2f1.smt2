...
(define-const input_1 Float64 (fp #b0 #b00000000000 #b1111001011101110011001010110001010101010011011110100))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b0 #b00000000000 #b1111001011101110011001010110001010101010011011110100))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
