...
(define-const input_2 Float64 (fp #b1 #b00000000000 #b0011010100100001100111001011011001101100110001011010))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b0 #b10000000001 #b0011010001011110001111110010111011000011010110011100))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
