...
(define-const input_1 Float64 (fp #b1 #b00000000000 #b1000001011101101001101011100001101100101000101100101))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b1 #b01111111110 #b0000010111011010011010111000011011001010001011001010))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
