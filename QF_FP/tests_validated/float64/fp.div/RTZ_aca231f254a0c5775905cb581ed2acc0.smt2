...
(define-const input_2 Float64 (fp #b0 #b00000000000 #b1000011110110011100111111110000100101000001001000110))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b1 #b01111111111 #b1110001011110001000110000100101011101110101110011000))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
