...
(define-const input_1 Float64 (fp #b0 #b10000000000 #b1001111011010111001110001001100011000111001000111000))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b1 #b11111111110 #b1001111011010111001110001001100011000111001000111001))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
