...
(define-const input_1 Float64 (fp #b0 #b00010111111 #b0101111100010110111001011100101000010011101110011011))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b1 #b10010111101 #b0101111100010110111001011100101000010011101110011100))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
