...
(define-const input_1 Float64 (fp #b1 #b10110100101 #b0111010000111011000100101001000100101011010110010000))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b1 #b10110100101 #b0111010000111011000100101001000100101011010110010000))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
