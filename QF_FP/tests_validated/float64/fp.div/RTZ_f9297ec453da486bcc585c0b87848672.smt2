...
(define-const input_2 Float64 (fp #b1 #b00000000000 #b1011111010110110011101101101100001101100010101011010))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b0 #b01111111111 #b0101011110100011001000010000000100011110111001001101))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
