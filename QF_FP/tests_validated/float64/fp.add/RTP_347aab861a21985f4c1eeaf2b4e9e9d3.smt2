...
(define-const input_1 Float64 (fp #b1 #b10100100001 #b0100001111111100000111110010000010110101101011111100))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b1 #b10100100001 #b0100001111111100000111110010000010110101101011111100))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
