...
(define-const input_2 Float64 (fp #b1 #b11111101111 #b0101011100110000111000001001111101000101110010001111))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b1 #b11111101111 #b0101011100110000111000001001111101000101110010001111))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
