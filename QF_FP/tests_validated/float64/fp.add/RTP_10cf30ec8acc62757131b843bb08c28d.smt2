...
(define-const input_2 Float64 (fp #b0 #b00000000000 #b1000000001110111111001100100110101000000001100100110))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b1 #b00000000000 #b0111111110001000000110011011001010111111110011011010))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
