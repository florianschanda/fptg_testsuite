...
(define-const input_2 Float64 (fp #b0 #b00000000000 #b0001011110101110011010111000001100110111101100011010))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b1 #b00000000000 #b1110100001010001100101000111110011001000010011100110))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
