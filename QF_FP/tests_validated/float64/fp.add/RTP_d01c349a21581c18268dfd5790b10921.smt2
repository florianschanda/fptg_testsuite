...
(define-const input_1 Float64 (fp #b0 #b01110101100 #b0111010010001011000011010000010100000001010110010011))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b0 #b01110101100 #b0111010010001011000011010000010100000001010110010100))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
