...
(define-const input_2 Float64 (fp #b1 #b00000000000 #b0100101100000110000010000100110010011110001101111000))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b1 #b00000000001 #b0100101100000110000010000100110010011110001101110111))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
