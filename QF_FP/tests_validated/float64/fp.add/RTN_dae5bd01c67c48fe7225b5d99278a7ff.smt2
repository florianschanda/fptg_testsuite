...
(define-const input_1 Float64 (fp #b0 #b00001101000 #b0001001100000011111011010011100011110100111110010110))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b0 #b00001101000 #b0001001100000011111011010011100011110100111110010110))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
