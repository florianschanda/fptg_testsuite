...
(define-const input_1 Float64 (fp #b0 #b00000101111 #b1100110100010000000001010100010000100101000110000001))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b0 #b00000101111 #b1100110100010000000001010100010000100101000101000001))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
