...
(define-const input_1 Float64 (fp #b1 #b11011010111 #b0111000011100101010111001100000110001100111000011110))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b1 #b11011010111 #b0111000011100101010111001100000110001100111000011110))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
