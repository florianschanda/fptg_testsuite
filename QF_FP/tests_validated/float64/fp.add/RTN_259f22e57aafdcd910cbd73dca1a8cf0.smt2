...
(define-const input_1 Float64 (fp #b1 #b11000000100 #b1101000111001111001100011001010111001101110001110111))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b1 #b11000000100 #b1101000111001111001100011001010111001101110001111000))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
