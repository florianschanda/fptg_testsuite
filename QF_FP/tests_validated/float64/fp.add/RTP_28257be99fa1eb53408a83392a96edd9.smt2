...
(define-const input_2 Float64 (fp #b0 #b00000000000 #b1100001010110010110010110110110101010101101110101000))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b1 #b00000000000 #b0011110101001101001101001001001010101010010001010111))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
