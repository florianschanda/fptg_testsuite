...
(define-const input_2 Float64 (fp #b0 #b00000000000 #b1011011000100111100000000001111011110010110101110000))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b1 #b00000000001 #b1011011000100111100000000001111011110010110101110000))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
