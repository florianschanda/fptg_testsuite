...
(define-const input_2 Float64 (fp #b1 #b00000000000 #b1101101110000011100001101101001100000111001111011110))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b1 #b00000000000 #b0010010001111100011110010010110011111000110000100010))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
