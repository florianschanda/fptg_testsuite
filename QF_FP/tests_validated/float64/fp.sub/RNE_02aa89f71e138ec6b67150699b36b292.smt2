...
(define-const input_1 Float64 (fp #b0 #b01010001010 #b0111011011101011010011011101001001001001110111100011))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b0 #b01010001010 #b0111011011101011010011011101001001001001110111100011))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
