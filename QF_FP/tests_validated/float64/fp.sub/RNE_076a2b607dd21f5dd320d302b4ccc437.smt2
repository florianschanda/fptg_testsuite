...
(define-const input_2 Float64 (fp #b0 #b00011000101 #b0010101011110101001000010101000100110101111101100001))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b1 #b00011000101 #b0010101011110101001000010101000100110101111101100001))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
