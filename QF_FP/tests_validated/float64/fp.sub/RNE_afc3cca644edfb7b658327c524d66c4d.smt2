...
(define-const input_2 Float64 (fp #b0 #b00000000000 #b0011011001101101011100010011000011101010110110110010))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b1 #b00000000001 #b0011011001101101011100010011000011101010110110110001))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
