...
(define-const input_1 Float64 (fp #b0 #b10011101100 #b1111000011111011101010100000000110110010110011101000))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b0 #b10011101100 #b1111000011111011101010100000000110110010110011101000))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
