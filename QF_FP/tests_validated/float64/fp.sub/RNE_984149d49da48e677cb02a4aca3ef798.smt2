...
(define-const input_2 Float64 (fp #b0 #b10001100100 #b0001011011011110000001110110101111001000001011000010))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b1 #b10001100100 #b0001011011011110000001110110101111001000001011000010))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
