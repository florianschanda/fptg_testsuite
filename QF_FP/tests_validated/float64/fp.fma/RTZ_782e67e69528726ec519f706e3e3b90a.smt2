...
(define-const input_1 Float64 (fp #b0 #b10111011101 #b0110110111010110011000101110011010010011000001111110))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b1 #b00000000000 #b1111101110011101100111001110101011000001011001001010))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
