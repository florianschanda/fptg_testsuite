...
(define-const input_3 Float64 (fp #b0 #b11000011110 #b0110101110101000010100101000100111011111100001000100))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b0 #b11000011110 #b0110101110101000010100101000100111011111100001000100))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
