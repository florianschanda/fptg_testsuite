...
(define-const input_1 Float64 (fp #b1 #b10111111110 #b1000111001010011010000110111001000101001001010101010))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_2 Float64 (fp #b0 #b11011101000 #b0001010111001100111111010110011111010101100110011101))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
