...
(define-const input_1 Float64 (fp #b1 #b00010111110 #b0100110110110000101000101010001010011010111101111011))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b0 #b11000111011 #b0001011000110100011000101001000101100110010101011111))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
