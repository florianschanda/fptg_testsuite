...
(define-const input_1 Float64 (fp #b1 #b11101111011 #b0001010110110010001000001111011100001101001111110111))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b0 #b00000000011 #b1001101010011001001111100001010010110001101110111001))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
