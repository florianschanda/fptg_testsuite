...
(define-const input_1 Float64 (fp #b1 #b10111111001 #b0110110011011101000001111010110010010110101101000100))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b1 #b00000000000 #b1101101110100101000001010000000011010000000111011101))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
