...
(define-const input_1 Float64 (fp #b0 #b10100010111 #b1111100010100111001010011011101110010101001011100101))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b1 #b11011111111 #b0100001100000100001010010001001101101000110011100110))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
