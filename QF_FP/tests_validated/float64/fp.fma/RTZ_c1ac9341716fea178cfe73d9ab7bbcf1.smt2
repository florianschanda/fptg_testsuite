...
(define-const input_1 Float64 (fp #b0 #b10100010001 #b1011011011111010110100001101000010110001000110000100))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b1 #b00000000000 #b1111001011001000101010100101001100111101010010011101))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
