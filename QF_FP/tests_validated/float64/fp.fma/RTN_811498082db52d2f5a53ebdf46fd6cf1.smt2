...
(define-const input_1 Float64 (fp #b0 #b11010010100 #b0010111110000100010101110010011101001101110110000111))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b0 #b10010110000 #b1110001010000000001000001110001110111010001101010100))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
