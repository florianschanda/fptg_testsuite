...
(define-const input_1 Float64 (fp #b1 #b10100000000 #b0110101001000001100001000111110011000111101111110111))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b1 #b00100000010 #b0110101001000001100001000111110011000111101111110111))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
