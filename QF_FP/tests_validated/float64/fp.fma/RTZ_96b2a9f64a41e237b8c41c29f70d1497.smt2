...
(define-const input_1 Float64 (fp #b0 #b10110110010 #b0101010010001011001100010111101010010100110001111000))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_2 Float64 (fp #b0 #b11110001111 #b0001110100100110111011000011001011001001001010100011))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b0 #b01111001110 #b1001101000001101010111010000001000110000110101101100))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
