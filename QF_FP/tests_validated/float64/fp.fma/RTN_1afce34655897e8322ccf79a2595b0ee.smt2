...
(define-const input_1 Float64 (fp #b1 #b11101110111 #b1111010111001010011010100100010010011100110101001001))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b0 #b01101111001 #b1111010111001010011010100100010010011100110101000111))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
