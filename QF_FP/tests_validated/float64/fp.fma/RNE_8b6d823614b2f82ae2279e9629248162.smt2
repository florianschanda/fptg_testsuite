...
(define-const input_1 Float64 (fp #b0 #b10100100010 #b1101010100000001001101011101100010000110111000010110))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b0 #b00010101010 #b0000011110000101011101001101001101010000110100010111))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
