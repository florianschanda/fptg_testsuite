...
(define-const input_2 Float64 (fp #b1 #b11010110011 #b1001000100101000011000000101011001100000110001101101))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b0 #b01010110101 #b1001000100101000011000000101011001100000110001101011))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
