...
(define-const input_1 Float64 (fp #b0 #b10011011001 #b1011110101100111000101011000010010100100110110101000))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b1 #b00011011011 #b1011110101100111000101011000010010100100110110100110))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
