...
(define-const input_1 Float64 (fp #b0 #b10000011110 #b0111001110110010101101100001000011101011101111011111))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b0 #b10011101000 #b0010110001100011100100111110011100000100101001101101))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
