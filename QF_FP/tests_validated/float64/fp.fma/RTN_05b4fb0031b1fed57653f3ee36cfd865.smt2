...
(define-const input_1 Float64 (fp #b0 #b10011001100 #b0101001111011101011011100011011100001111000110110010))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b1 #b00100010100 #b0101111110000011011110011110101110001010100101011000))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
