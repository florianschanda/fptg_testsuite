...
(define-const input_1 Float64 (fp #b1 #b00100010111 #b0010100100111101110110111011111111001011000110101010))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b0 #b11111101100 #b1010101110000010100111101101110011010100010111011011))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
