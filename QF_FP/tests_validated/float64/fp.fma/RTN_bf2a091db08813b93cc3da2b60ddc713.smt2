...
(define-const input_1 Float64 (fp #b0 #b10111010010 #b0101100101101100110001111000111001100111010001000010))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b0 #b01001111000 #b0011111110101100010000101000001000000010111110000101))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
