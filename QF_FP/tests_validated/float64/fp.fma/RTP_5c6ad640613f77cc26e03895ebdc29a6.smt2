...
(define-const input_1 Float64 (fp #b1 #b00110010101 #b0010110010000110101010011101010110010100010010000000))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b1 #b00110010101 #b0010110010000110101010011101010110010100010010000000))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
