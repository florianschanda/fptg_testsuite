...
(define-const input_1 Float64 (fp #b1 #b11100101010 #b1010001010100000101101010000001101000000001101111110))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b0 #b01100101100 #b1010001010100000101101010000001101000000001101111100))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
