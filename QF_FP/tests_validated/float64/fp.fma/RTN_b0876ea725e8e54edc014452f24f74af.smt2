...
(define-const input_3 Float64 (fp #b1 #b01111111001 #b0111101100101000000111100101101000110000011001110101))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b1 #b01111111001 #b0111101100101000000111100101101000110000011001110101))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
