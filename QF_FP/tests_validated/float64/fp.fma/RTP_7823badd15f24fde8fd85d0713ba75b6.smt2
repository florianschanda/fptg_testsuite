...
(define-const input_1 Float64 (fp #b0 #b01010101011 #b1011101000110100001011101111011000101111001100010111))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b1 #b00000000000 #b1111011110010010100111101011111000001110011000010000))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
