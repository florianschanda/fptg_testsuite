...
(define-const input_3 Float64 (fp #b0 #b00010000001 #b0111010001011001001101011000101111000010000111001001))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b0 #b00010000001 #b0111010001011001001101011000101111000010000111001001))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
