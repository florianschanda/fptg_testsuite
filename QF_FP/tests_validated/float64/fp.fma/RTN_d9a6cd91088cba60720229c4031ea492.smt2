...
(define-const input_3 Float64 (fp #b1 #b10100101000 #b1110001111001100001001000101101101000010110010110100))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b1 #b10100101000 #b1110001111001100001001000101101101000010110010110100))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
