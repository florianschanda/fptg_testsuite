...
(define-const input_1 Float64 (fp #b0 #b00011001100 #b0010000101001100101101001000011110110001000110100101))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b1 #b10000001001 #b0100100101111101101100010100010000010111011110010111))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
