...
(define-const input_1 Float64 (fp #b1 #b10110001001 #b1000010110111001101101101101111111000010100101101101))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b0 #b00110001011 #b1000010110111001101101101101111111000010100101101100))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
