...
(define-const input_1 Float64 (fp #b1 #b10111100110 #b0011001000011001111010011101001000001011000101010111))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b1 #b11000000001 #b1010011100111010001001101110001000101111100100100000))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
