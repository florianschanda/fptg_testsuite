...
(define-const input_1 Float64 (fp #b1 #b01100110011 #b0111010001100000100010011010110111111011101001011000))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b0 #b11111011011 #b0100111101000110111101011010101010110101010110110101))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
