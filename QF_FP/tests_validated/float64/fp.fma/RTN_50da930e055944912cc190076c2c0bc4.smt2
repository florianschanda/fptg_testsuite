...
(define-const input_1 Float64 (fp #b1 #b11111110111 #b1000101101100100101000101011010000101010100110001100))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b1 #b11111110111 #b1000101101100100101000101011010000101010100110001101))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
