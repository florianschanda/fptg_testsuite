...
(define-const input_1 Float64 (fp #b1 #b10001010110 #b0010100110111000000011000000111001111001110100001100))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b0 #b00010001000 #b1010101101100100000000010100101001000110100101110010))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
