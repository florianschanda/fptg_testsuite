...
(define-const input_1 Float64 (fp #b1 #b11010001010 #b0010010111111011001100001000010011110110001110000110))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b0 #b01010001100 #b0010010111111011001100001000010011110110001110000101))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
