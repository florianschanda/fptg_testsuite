...
(define-const input_1 Float64 (fp #b1 #b11011110000 #b0100001100000110110010001000110101010001110101100110))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b1 #b00000000000 #b0110010000010111100110100001100101111101100101011010))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
