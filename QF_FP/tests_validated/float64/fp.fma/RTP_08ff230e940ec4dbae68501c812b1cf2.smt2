...
(define-const input_3 Float64 (fp #b0 #b00000010010 #b1101000111110101011001001010110111110110000101111001))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b0 #b00000010010 #b1101000111110101011001001010110111110110000101111001))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
