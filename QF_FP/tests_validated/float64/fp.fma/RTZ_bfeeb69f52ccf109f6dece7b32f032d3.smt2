...
(define-const input_3 Float64 (fp #b1 #b11100111101 #b0110001001100010111011001001110000110111001000100110))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b1 #b11100111101 #b0110001001100010111011001001110000110111001000100110))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
