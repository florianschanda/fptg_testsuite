...
(define-const input_1 Float64 (fp #b1 #b11110010010 #b1101001110000001100011111111100000010011101011010001))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b0 #b11010001110 #b0001101111011110101110101101110100001100100100010111))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
