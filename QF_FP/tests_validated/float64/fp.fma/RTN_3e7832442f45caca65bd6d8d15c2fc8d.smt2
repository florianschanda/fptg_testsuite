...
(define-const input_1 Float64 (fp #b1 #b10001011001 #b0001101101001111001100110111011011110001110111000010))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b0 #b10110100010 #b1010100010101110101010100011100111010110010110010000))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
