...
(define-const input_1 Float64 (fp #b0 #b10011011001 #b0010100110000001100111010111111101010100100111111100))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b1 #b11011000110 #b0000011110111001110110010000101101001011010101101100))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
