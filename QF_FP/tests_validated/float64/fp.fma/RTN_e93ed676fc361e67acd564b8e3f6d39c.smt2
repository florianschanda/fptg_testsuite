...
(define-const input_1 Float64 (fp #b0 #b11000010001 #b0011110111011011101010101000010001111001001001001110))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_2 Float64 (fp #b0 #b11111100111 #b0100101010110000101100011011000111000001101101101111))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
