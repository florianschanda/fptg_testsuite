...
(define-const input_1 Float64 (fp #b1 #b11111011101 #b1111101110101011010101111110100001001101111100010011))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_2 Float64 (fp #b1 #b10100000100 #b1111001100101000100101001101011010011110100111110010))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
