...
(define-const input_1 Float64 (fp #b0 #b10000000111 #b1111100011011001011110010111111000001110100011101100))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b0 #b00000000000 #b0011100101001100000001100111001000101000101110010101))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
