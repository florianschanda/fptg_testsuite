...
(define-const input_1 Float64 (fp #b0 #b00011010100 #b0000100000010100110111100000000000110111010000000011))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b1 #b10001000101 #b0111111001101111011101100111000100011111101111001100))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
