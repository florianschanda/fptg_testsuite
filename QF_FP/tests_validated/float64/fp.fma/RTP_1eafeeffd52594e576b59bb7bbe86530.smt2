...
(define-const input_1 Float64 (fp #b1 #b10001000101 #b0010011010111001100010101010000011110010001100101011))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b0 #b01111101111 #b0110001110010111010111110010110100011110010110111110))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
