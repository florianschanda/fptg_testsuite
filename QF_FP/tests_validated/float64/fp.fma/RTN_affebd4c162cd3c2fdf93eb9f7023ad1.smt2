...
(define-const input_2 Float64 (fp #b1 #b10110101001 #b0011011011100111110111010110011011111011000111101000))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b0 #b00110101011 #b0011011011100111110111010110011011111011000111101000))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
