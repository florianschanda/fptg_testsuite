...
(define-const input_1 Float64 (fp #b0 #b00101110110 #b0100000110000010011101111001010100001100101100010101))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b1 #b11101101011 #b0110000100011010010011001001100001000000000101100011))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
