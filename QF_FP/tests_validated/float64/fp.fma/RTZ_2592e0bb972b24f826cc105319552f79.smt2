...
(define-const input_2 Float64 (fp #b0 #b10001101111 #b1111000010011111101111010100101000101000110010011000))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b1 #b00001110001 #b1111000010011111101111010100101000101000110010010110))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
