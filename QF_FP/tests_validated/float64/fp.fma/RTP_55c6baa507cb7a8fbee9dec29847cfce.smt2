...
(define-const input_1 Float64 (fp #b1 #b11011100010 #b0000011111111011010110101010110010010001111111010010))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b0 #b11011000100 #b0100100001111111001001001011100011011101110010001000))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
