...
(define-const input_1 Float64 (fp #b0 #b10111101011 #b0100110100011010010010010001011011010100000011101110))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b1 #b00111101101 #b0100110100011010010010010001011011010100000011101100))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
