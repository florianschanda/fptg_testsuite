...
(define-const input_1 Float64 (fp #b1 #b00010110001 #b1010000001101011001100000100011100010011100011101110))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b0 #b10110111111 #b1010110110100100110111010100100110101110011111011011))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
