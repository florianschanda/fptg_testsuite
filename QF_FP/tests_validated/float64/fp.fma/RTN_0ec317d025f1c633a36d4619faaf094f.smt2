...
(define-const input_1 Float64 (fp #b0 #b10111010001 #b0000101111110101100001101000000010101000101010100010))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_2 Float64 (fp #b0 #b11011011111 #b0111000111100010101000100100010111111111101001000111))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b1 #b00000000000 #b1100101011001001110101001111110101110101110100110001))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
