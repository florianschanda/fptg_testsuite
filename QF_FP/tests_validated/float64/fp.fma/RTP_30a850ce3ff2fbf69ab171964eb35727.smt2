...
(define-const input_1 Float64 (fp #b0 #b00011100111 #b0111111110001010000101011010111111110001110111101110))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b0 #b00011100111 #b0111111110001010000101011010111111110001110111101110))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
