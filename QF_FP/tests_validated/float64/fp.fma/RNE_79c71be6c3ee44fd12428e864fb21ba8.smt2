...
(define-const input_1 Float64 (fp #b1 #b11110110001 #b0011101101111100010011101101000010000011011001011100))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_2 Float64 (fp #b0 #b10001011011 #b0001011110111010101110110010000101000011010111000100))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
