...
(define-const input_1 Float64 (fp #b1 #b11101100100 #b0111001100100101000110001011110100110110000001001100))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_2 Float64 (fp #b1 #b11011000011 #b0101000011000001011011000000100000100000011101010011))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b1 #b11111001011 #b1110001010111110000010101011011111100100111100110010))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
