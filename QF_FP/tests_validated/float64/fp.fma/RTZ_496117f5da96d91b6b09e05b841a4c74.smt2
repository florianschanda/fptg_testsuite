...
(define-const input_1 Float64 (fp #b1 #b00000010001 #b0010110101100011111101100011001101001000100111010100))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b1 #b00000000000 #b1100011001011010110100010100111001100010101101101111))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
