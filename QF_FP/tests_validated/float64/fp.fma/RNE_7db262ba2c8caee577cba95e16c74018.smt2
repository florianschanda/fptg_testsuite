...
(define-const input_2 Float64 (fp #b0 #b10011100010 #b1011011100010100110010100100111001100010101101001001))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b1 #b00011100100 #b1011011100010100110010100100111001100010101101000111))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
