...
(define-const input_1 Float64 (fp #b1 #b10000111110 #b1010010100110101010100100110001100100100101011110110))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b0 #b00000000000 #b0001101001110011010011110001101000001000010110010000))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
