...
(define-const input_3 Float64 (fp #b1 #b11010100111 #b0000100011100011010011000010001001110000010110010101))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b1 #b11010100111 #b0000100011100011010011000010001001110000010110010101))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
