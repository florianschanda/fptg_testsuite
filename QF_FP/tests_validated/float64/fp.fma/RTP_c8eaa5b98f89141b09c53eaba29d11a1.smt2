...
(define-const input_1 Float64 (fp #b1 #b10101101001 #b0110010111110100010010011011011110001110110010010100))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b1 #b00000100000 #b1111110011100010110010100001100000110100010010101100))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
