...
(define-const input_1 Float64 (fp #b0 #b00011001111 #b0010111111100001000101101000101101010110110001110111))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b0 #b11101001100 #b1010101000001011001110010110100000101101000111000100))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
