...
(define-const input_1 Float64 (fp #b0 #b11011110011 #b0110011000101111100000000010001101111101110100010100))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b0 #b11011110011 #b0110011000101111100000000010001101111101110100010100))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
