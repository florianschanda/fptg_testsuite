...
(define-const input_1 Float64 (fp #b1 #b11110010110 #b0111100101000110001000110100110000011111011001101000))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b1 #b00000000000 #b0110001010010010011001110010100010111111111000110100))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
