...
(define-const input_3 Float64 (fp #b0 #b11001111010 #b0101010100010100101110011111001101110111111100110100))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b0 #b11001111010 #b0101010100010100101110011111001101110111111100110100))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
