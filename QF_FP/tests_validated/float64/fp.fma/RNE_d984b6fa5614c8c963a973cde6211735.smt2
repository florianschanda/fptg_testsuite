...
(define-const input_1 Float64 (fp #b1 #b10100001001 #b1010001101110011010111100000110011111001101100010000))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b0 #b00000111001 #b1001010110001011010101011010000010110001010011111111))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
