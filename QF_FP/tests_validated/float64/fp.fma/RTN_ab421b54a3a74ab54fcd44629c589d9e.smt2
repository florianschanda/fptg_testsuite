...
(define-const input_2 Float64 (fp #b0 #b11111000111 #b1011011111011110011011001010000111101100011010010100))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b1 #b01111001001 #b1011011111011110011011001010000111101100011010010100))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
