...
(define-const input_1 Float64 (fp #b1 #b01000000001 #b0100100000010011010100010111010010011001011111011110))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b0 #b10000010011 #b0001111011101000100101000100010101111010011000111111))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
