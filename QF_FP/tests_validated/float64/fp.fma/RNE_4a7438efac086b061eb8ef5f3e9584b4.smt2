...
(define-const input_1 Float64 (fp #b0 #b01001000111 #b0100010000101001001111010001010011101000011110001000))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b0 #b10001101000 #b1101001110000111111110011110000101000101110010111110))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
