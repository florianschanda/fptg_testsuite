...
(define-const input_1 Float64 (fp #b0 #b10111110110 #b0010001000010011000011110011010110111000001100101100))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b0 #b11011101011 #b1110100101100100100110011010000101100110011100000101))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
