...
(define-const input_3 Float64 (fp #b0 #b10111101001 #b0010101111001100011010000100111010111011101111000000))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b0 #b10111101001 #b0010101111001100011010000100111010111011101111000000))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
