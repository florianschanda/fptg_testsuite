...
(define-const input_2 Float64 (fp #b0 #b11111011010 #b1011100000100001000101111000010010000111111001100010))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b1 #b01111011100 #b1011100000100001000101111000010010000111111001100000))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
