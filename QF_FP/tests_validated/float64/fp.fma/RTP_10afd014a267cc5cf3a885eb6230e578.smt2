...
(define-const input_1 Float64 (fp #b0 #b10100010011 #b0100011010111011110001011110000011000011010110000010))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b0 #b11101111001 #b0110110111110011101111001111010101011000011100100100))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
