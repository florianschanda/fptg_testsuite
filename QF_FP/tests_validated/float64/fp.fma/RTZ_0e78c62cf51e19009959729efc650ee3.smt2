...
(define-const input_1 Float64 (fp #b1 #b11010110100 #b1100011110100001110110111000110111110111011100001011))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_2 Float64 (fp #b1 #b11011011110 #b1100110011111101011001000000101010100100100110110100))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b1 #b11001111100 #b1111010100010011101001011101110000111110110111110111))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
