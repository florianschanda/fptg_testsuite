...
(define-const input_1 Float64 (fp #b0 #b01110010011 #b0101010101011101100110101101000011111111001111010101))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b0 #b10001100101 #b0101011101111001101110110111011000110001111000101101))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
