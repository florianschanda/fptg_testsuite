...
(define-const input_3 Float64 (fp #b0 #b10001000100 #b1000100100111011010000010101001111001000010001110101))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b0 #b10001000100 #b1000100100111011010000010101001111001000010001110101))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
