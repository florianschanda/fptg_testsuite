...
(define-const input_1 Float64 (fp #b0 #b11001010010 #b0000110101110000110011111110111110101111001110001010))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b1 #b01001010100 #b0000110101110000110011111110111110101111001110001000))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
