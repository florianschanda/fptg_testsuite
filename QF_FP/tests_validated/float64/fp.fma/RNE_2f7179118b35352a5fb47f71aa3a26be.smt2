...
(define-const input_1 Float64 (fp #b1 #b11100000000 #b1101100101101111110101011010110010101011101110101110))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b1 #b01100011111 #b0110010010010110011110110011100101111000000111010001))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
