...
(define-const input_1 Float64 (fp #b1 #b00011001001 #b0100011111011101111100011001010000001000010010001110))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b1 #b00011001001 #b0100011111011101111100011001010000001000010010001110))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
