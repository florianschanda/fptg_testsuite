...
(define-const input_1 Float64 (fp #b1 #b10010011101 #b0100011100101010100101001100011011110001001010010100))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b0 #b00010011111 #b0100011100101010100101001100011011110001001010010011))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
