...
(define-const input_1 Float64 (fp #b0 #b11011110011 #b1100011010011111110111010110110001001010000000011010))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_2 Float64 (fp #b1 #b11111110011 #b1110001000101110001010001010101000100000111001001101))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
