...
(define-const input_1 Float64 (fp #b0 #b10110110010 #b1110001101110001000110110001100010011110011101001001))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b1 #b00110110100 #b1110001101110001000110110001100010011110011101001000))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
