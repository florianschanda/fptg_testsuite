...
(define-const input_3 Float64 (fp #b0 #b11000100011 #b0010100111001100100100101111000011011111101101000000))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b0 #b11000100011 #b0010100111001100100100101111000011011111101101000000))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
