...
(define-const input_1 Float64 (fp #b0 #b10000010110 #b1100100001001110001000101110101100000101010010100111))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b0 #b00000000000 #b0010100110100100000001001011111000111000111000000010))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
