...
(define-const input_3 Float64 (fp #b1 #b00010011000 #b0100001011101110001000101100101001110010111110100101))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b1 #b00010011000 #b0100001011101110001000101100101001110010111110100101))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
