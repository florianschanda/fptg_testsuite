...
(define-const input_1 Float64 (fp #b1 #b11111110010 #b0110001101110111001000011100010001101100011011010111))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b0 #b00000000000 #b0101111110000001010101000010100001101101110101111000))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
