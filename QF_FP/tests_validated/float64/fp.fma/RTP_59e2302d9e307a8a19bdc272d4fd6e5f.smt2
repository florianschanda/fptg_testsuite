...
(define-const input_3 Float64 (fp #b1 #b10111010011 #b0111101101110000010001100011000001000010110001101001))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b1 #b10111010011 #b0111101101110000010001100011000001000010110001101001))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
