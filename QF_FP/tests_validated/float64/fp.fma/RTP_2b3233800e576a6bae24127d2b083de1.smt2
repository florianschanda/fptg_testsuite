...
(define-const input_2 Float64 (fp #b0 #b10011011100 #b0000101001111110001110100101111110110100011100111010))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b1 #b00011011110 #b0000101001111110001110100101111110110100011100111010))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
