...
(define-const input_1 Float32 (fp #b1 #b10011100 #b00101001011010101000000))
;; should be -623726592.0
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float32 (fp #b0 #b10010110 #b01011000100010100001100))
;; should be 11289868.0
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
