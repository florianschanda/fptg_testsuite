...
(define-const input_2 Float32 (fp #b0 #b10110101 #b01000111100110011111111))
;; should be 23052908396281856.0
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float32 (fp #b0 #b10010110 #b11110011000111111111010))
;; should be 16355322.0
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
