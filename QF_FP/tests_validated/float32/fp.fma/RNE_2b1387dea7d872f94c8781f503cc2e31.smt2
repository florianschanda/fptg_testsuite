...
(define-const input_2 Float32 (fp #b1 #b10101111 #b01001001001110011000110))
;; should be -361986487484416.0
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float32 (fp #b0 #b00000000 #b11010111111110110011111))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
