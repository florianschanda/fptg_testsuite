...
(define-const input_2 Float32 (fp #b1 #b10101111 #b10111111101101111001110))
;; should be -492270293876736.0
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float32 (fp #b1 #b00000000 #b10111111011010111111111))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
