...
(define-const input_1 Float32 (fp #b0 #b01000100 #b00011101101011001111010))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_2 Float32 (fp #b1 #b10011101 #b11101110100101010110111))
;; should be -2074434432.0
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
