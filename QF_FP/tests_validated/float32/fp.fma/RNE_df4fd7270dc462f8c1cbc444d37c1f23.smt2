...
(define-const input_1 Float32 (fp #b0 #b10011011 #b00001111110110001011001))
;; should be 285051680.0
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float32 (fp #b1 #b11110011 #b10001101111100010001100))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
