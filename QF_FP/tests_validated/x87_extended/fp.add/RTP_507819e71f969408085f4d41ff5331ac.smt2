...
(define-const input_2 (_ FloatingPoint 15 64) (fp #b1 #b000000000000000 #b111010101011110110100111001110101111101010010101100011101011111))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
...
(define-const expected_result (_ FloatingPoint 15 64) (fp #b0 #b000000000000000 #b000101010100001001011000110001010000010101101010011100010100000))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
