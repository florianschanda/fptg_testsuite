...
(define-const input_1 (_ FloatingPoint 15 64) (fp #b1 #b001000000001000 #b010101001100110111100011111110000000010001000010101101010111111))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 (_ FloatingPoint 15 64) (fp #b0 #b111001000001111 #b110010101001000100000011111110110000000111000111110001000110100))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
