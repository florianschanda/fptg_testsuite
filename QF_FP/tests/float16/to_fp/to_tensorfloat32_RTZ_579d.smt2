...
(define-const potato Float16 (fp #b1 #b01110 #b1101001110))
;; should be -0.9130859375
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result (_ FloatingPoint 8 11) (fp #b1 #b01111110 #b1101001110))
;; should be -0.9130859375
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
