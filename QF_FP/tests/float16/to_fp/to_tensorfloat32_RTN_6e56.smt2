...
(define-const potato Float16 (fp #b0 #b01101 #b0100101110))
;; should be 0.32373046875
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result (_ FloatingPoint 8 11) (fp #b0 #b01111101 #b0100101110))
;; should be 0.32373046875
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
