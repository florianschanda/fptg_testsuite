...
(define-const potato Float16 (fp #b1 #b01100 #b0000010010))
;; should be -0.127197265625
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result (_ FloatingPoint 8 11) (fp #b1 #b01111100 #b0000010010))
;; should be -0.127197265625
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
