...
(define-const input_1 Float64 (fp #b0 #b10110111100 #b0100111100101110001010001010101100100110110011000101))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b0 #b11011100000 #b0100101010010101010000010011110110001000101000001111))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
