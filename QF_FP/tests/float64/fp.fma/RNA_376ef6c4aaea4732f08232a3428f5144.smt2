...
(define-const input_2 Float64 (fp #b1 #b10010110000 #b1100000001101100101110111011011010001101000111000100))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b0 #b00010110010 #b1100000001101100101110111011011010001101000111000010))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
