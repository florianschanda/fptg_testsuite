...
(define-const input_1 Float64 (fp #b1 #b11001010110 #b0000001100011100101110100001010000110101001011110101))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b1 #b11001010110 #b0000001100011100101110100001010000110101001011110101))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
