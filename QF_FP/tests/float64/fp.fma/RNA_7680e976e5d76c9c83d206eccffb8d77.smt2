...
(define-const input_3 Float64 (fp #b1 #b11110111011 #b0010111000000010000101000100000111011000001100111111))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b1 #b11110111011 #b0010111000000010000101000100000111011000001100111111))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
