...
(define-const input_1 Float64 (fp #b0 #b11000011111 #b0111001110001101001000100111000011111110111101110111))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b1 #b00000000000 #b0010010100000011110110101110100001111011101101000001))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
