...
(define-const input_2 Float64 (fp #b1 #b11100100100 #b0111011110100100000000010011000100000110111001011000))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b0 #b01100100110 #b0111011110100100000000010011000100000110111001010111))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
