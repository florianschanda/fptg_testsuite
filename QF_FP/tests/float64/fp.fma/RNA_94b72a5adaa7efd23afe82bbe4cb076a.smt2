...
(define-const input_3 Float64 (fp #b1 #b11111110011 #b0100100000010100101100011001110101100001110011010100))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b1 #b11111110011 #b0100100000010100101100011001110101100001110011010100))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
