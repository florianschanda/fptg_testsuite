...
(define-const input_3 Float64 (fp #b0 #b11110100101 #b0100010111110111111110010000000100001010011101010101))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b0 #b11110100101 #b0100010111110111111110010000000100001010011101010101))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
