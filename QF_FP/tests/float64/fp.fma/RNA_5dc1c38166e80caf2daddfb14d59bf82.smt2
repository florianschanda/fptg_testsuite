...
(define-const input_3 Float64 (fp #b0 #b00111001010 #b1000010001100100000001001101111100101010111110111001))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b0 #b00111001010 #b1000010001100100000001001101111100101010111110111001))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
