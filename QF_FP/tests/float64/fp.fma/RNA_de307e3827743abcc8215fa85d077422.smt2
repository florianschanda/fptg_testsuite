...
(define-const input_3 Float64 (fp #b1 #b11100101010 #b1100100001100110011001001010111100010101001111000001))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b1 #b11100101010 #b1100100001100110011001001010111100010101001111000001))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
