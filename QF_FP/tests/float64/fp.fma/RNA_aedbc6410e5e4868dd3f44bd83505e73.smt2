...
(define-const input_2 Float64 (fp #b0 #b11101001000 #b1011001101010111110111011001010101010011001010101110))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b1 #b01101001010 #b1011001101010111110111011001010101010011001010101100))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
