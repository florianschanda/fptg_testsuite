...
(define-const input_2 Float64 (fp #b1 #b11110010011 #b0111010101111100010011111110100111000110011000101101))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b0 #b01110010101 #b0111010101111100010011111110100111000110011000101101))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
