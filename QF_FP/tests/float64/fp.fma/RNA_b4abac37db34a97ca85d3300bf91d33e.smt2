...
(define-const input_3 Float64 (fp #b0 #b00011110011 #b0111000001111011111011101101110010011011001100010111))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b0 #b00011110011 #b0111000001111011111011101101110010011011001100010111))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
