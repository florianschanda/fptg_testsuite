...
(define-const input_1 Float64 (fp #b0 #b11110000000 #b1110011100010001001111000100001110001100000011110100))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b0 #b11110000000 #b1110011100010001001111000100001110001100000011110100))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
