...
(define-const input_3 Float64 (fp #b0 #b01010011011 #b1111011011111110010101110111110011110011101101001010))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b0 #b01010011011 #b1111011011111110010101110111110011110011101101001010))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
