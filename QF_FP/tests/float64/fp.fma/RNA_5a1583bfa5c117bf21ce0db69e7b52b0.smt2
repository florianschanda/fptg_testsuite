...
(define-const input_1 Float64 (fp #b1 #b11000111101 #b1001010110000011001010100011001000100110110110010001))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b0 #b01000111111 #b1001010110000011001010100011001000100110110110001111))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
