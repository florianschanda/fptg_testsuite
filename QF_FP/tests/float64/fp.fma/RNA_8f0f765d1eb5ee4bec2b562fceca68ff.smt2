...
(define-const input_2 Float64 (fp #b1 #b01111001111 #b1000100001110010101111111010100001110010010011101101))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000011001))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
