...
(define-const input_3 Float64 (fp #b1 #b10001001101 #b1001010110010110101000111101111100010010011101011011))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b1 #b10001001101 #b1001010110010110101000111101111100010010011101011011))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
