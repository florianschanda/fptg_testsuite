...
(define-const input_3 Float64 (fp #b1 #b01000010110 #b1100110111111000000011010011110110101010001100000111))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b1 #b01000010110 #b1100110111111000000011010011110110101010001100000111))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
