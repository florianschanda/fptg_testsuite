...
(define-const input_1 Float64 (fp #b0 #b10011000100 #b0101110001110100010000110000101000001011000001010111))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b1 #b00011000110 #b0101110001110100010000110000101000001011000001010110))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
