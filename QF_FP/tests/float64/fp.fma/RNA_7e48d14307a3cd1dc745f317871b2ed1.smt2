...
(define-const input_1 Float64 (fp #b1 #b11101001001 #b1110100000100100011011110011001011000001000101001000))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_2 Float64 (fp #b0 #b11101100000 #b1001010111101010100000010011100100110101000111110001))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
