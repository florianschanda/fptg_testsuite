...
(define-const input_1 Float64 (fp #b1 #b10000010100 #b1100001011001110001001000101101111100100001000101010))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b1 #b10000010100 #b1100001011001110001001000101101111100100001000101010))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
