...
(define-const input_1 Float64 (fp #b0 #b11011111101 #b0110010011011100001011100111100101110000101010110101))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b1 #b01011111111 #b0110010011011100001011100111100101110000101010110100))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
