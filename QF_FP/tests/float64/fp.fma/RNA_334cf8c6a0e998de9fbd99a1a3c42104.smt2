...
(define-const input_3 Float64 (fp #b0 #b10001101000 #b1100100100000110100100111110000001111110110011011010))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b0 #b10001101000 #b1100100100000110100100111110000001111110110011011010))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
