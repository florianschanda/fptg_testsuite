...
(define-const input_2 Float64 (fp #b0 #b11100100110 #b0000110011011100010101011101010110010010100001110111))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b1 #b01100101000 #b0000110011011100010101011101010110010010100001110111))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
