...
(define-const input_3 Float64 (fp #b1 #b00101110011 #b1111010011000010000011010110110010000111111100101000))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b1 #b00101110011 #b1111010011000010000011010110110010000111111100101000))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
