...
(define-const input_1 Float64 (fp #b1 #b11101100110 #b1101000110110001101101110001001101100101100001101001))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b1 #b00000000000 #b0101001001001010010101000000111111000010100110001110))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
