...
(define-const input_1 Float64 (fp #b0 #b10011100000 #b0011011000000101000001000010011100111001111110101010))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b1 #b00011100010 #b0011011000000101000001000010011100111001111110101001))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
