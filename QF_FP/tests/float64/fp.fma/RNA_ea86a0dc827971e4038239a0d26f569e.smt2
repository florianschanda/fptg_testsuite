...
(define-const input_3 Float64 (fp #b1 #b00011111011 #b0111001100010000100100111100111001110010001010001100))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b1 #b00011111011 #b0111001100010000100100111100111001110010001010001100))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
