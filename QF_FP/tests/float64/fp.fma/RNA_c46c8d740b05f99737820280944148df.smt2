...
(define-const input_3 Float64 (fp #b0 #b10110101101 #b0011101000011000010101010111010101010000101101111000))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b0 #b10110101101 #b0011101000011000010101010111010101010000101101111000))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
