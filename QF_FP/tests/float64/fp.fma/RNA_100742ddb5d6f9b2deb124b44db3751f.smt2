...
(define-const input_3 Float64 (fp #b0 #b00101111111 #b1011100001010110001101100111001010100100011011000110))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b0 #b00101111111 #b1011100001010110001101100111001010100100011011000110))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
