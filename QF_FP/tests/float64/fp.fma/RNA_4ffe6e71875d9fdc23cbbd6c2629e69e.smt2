...
(define-const input_1 Float64 (fp #b0 #b00001001000 #b0110011001110110001011101100101101000111001000010011))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b0 #b00001001000 #b0110011001110110001011101100101101000111001000010011))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
