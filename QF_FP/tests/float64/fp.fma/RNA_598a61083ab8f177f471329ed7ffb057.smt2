...
(define-const input_3 Float64 (fp #b0 #b11110101101 #b1010101100101111011111110010100111001000001011000000))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b0 #b11110101101 #b1010101100101111011111110010100111001000001011000000))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
