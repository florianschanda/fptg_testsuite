...
(define-const input_3 Float64 (fp #b0 #b10110100000 #b0011111001001110101101111111001101000100000011111110))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b0 #b10110100000 #b0011111001001110101101111111001101000100000011111110))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
