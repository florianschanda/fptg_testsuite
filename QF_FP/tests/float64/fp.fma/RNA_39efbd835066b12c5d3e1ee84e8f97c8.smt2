...
(define-const input_3 Float64 (fp #b1 #b01010011011 #b1010010111111010010111011110010001001111010101111110))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b1 #b01010011011 #b1010010111111010010111011110010001001111010101111110))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
