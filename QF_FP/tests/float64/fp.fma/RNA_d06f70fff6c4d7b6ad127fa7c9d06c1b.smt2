...
(define-const input_1 Float64 (fp #b0 #b10000011010 #b0011110000010110000101111110100110001010001101110100))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b0 #b00000000000 #b0000110101111111000011001011010110101101111100011000))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
