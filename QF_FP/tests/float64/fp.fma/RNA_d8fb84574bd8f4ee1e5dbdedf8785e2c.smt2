...
(define-const input_1 Float64 (fp #b0 #b11110111111 #b0010111100111001010111000111011100101001001101001110))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b0 #b01111000001 #b0010111100111001010111000111011100101001001101001110))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
