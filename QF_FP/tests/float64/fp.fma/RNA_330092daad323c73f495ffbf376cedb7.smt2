...
(define-const input_1 Float64 (fp #b0 #b11011011011 #b0000101011110001101001110110100000011001001001000011))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b1 #b10110001001 #b1101101110101100010011100001010100010110101010101100))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
