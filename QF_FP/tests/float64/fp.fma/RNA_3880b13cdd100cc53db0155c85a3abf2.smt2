...
(define-const input_3 Float64 (fp #b1 #b01000101111 #b0110010111001001010011000110100100100001100010000101))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b1 #b01000101111 #b0110010111001001010011000110100100100001100010000101))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
