...
(define-const input_1 Float64 (fp #b0 #b10011111101 #b0010100101000101101101100011110110100110111011111100))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b0 #b10000100011 #b0000000010011101011011010000101010010100100000111100))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
