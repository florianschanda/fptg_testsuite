...
(define-const input_1 Float64 (fp #b1 #b01101000010 #b1011001000111001100111101111000000100111101000000110))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b1 #b01101000010 #b1011001000111001100111101111000000100111101000000110))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
