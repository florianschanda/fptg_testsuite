...
(define-const input_1 Float64 (fp #b0 #b10101110011 #b1010101111011011100001010000001111001111100100010001))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_2 Float64 (fp #b0 #b11111111101 #b1001111110000101001000010110001010000011010100110110))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
