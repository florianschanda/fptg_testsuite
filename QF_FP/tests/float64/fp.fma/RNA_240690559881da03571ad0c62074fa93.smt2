...
(define-const input_3 Float64 (fp #b0 #b10111100101 #b0111111101000011000010011001011110011011001000000110))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b0 #b10111100101 #b0111111101000011000010011001011110011011001000000110))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
