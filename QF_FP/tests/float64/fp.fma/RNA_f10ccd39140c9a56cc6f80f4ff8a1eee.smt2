...
(define-const input_3 Float64 (fp #b1 #b01111001010 #b1011011110000000001011000100011100100101011000010110))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b1 #b01111001010 #b1011011110000000001011000100011100100101011000010110))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
