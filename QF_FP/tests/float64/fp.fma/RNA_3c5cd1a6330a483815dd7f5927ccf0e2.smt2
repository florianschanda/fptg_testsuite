...
(define-const input_1 Float64 (fp #b1 #b10111010110 #b1110010000111000001011111000011000001010001011101011))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b0 #b00010100011 #b1101001110000011011101100011101001101010110100000101))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
