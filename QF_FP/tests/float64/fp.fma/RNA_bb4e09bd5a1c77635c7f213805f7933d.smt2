...
(define-const input_1 Float64 (fp #b0 #b11101101000 #b0111001011101010011010010110010010011111110011000001))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_2 Float64 (fp #b1 #b10101000101 #b0010000110111011111000001011001100011011110011110010))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
