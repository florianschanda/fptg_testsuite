...
(define-const potato (_ FloatingPoint 7 4) (fp #b0 #b0110010 #b100))
;; should be 0.00018310546875
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result (_ FloatingPoint 5 5) (fp #b0 #b00010 #b1000))
;; should be 0.00018310546875
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
