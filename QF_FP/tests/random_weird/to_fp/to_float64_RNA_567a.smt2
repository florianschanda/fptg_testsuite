...
(define-const potato (_ FloatingPoint 5 3) (fp #b0 #b00011 #b00))
...
(define-const expected_result Float64 (fp #b0 #b01111110011 #b0000000000000000000000000000000000000000000000000000))
;; should be 0.000244140625
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
