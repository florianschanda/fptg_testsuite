...
(define-const potato (_ FloatingPoint 12 11) (fp #b1 #b100001101000 #b0001111000))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result (_ FloatingPoint 8 11) (fp #b1 #b11101000 #b0001111000))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
