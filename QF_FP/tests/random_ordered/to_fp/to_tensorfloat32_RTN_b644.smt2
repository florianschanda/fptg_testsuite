...
(define-const potato (_ FloatingPoint 10 16) (fp #b0 #b1001101000 #b011001010110011))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result (_ FloatingPoint 8 11) (fp #b0 #b11101000 #b0110010101))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
