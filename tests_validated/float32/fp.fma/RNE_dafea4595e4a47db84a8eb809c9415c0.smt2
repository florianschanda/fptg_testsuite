...
(define-const input_1 Float32 (fp #b1 #b10101011 #b00110110101011101011001))
;; should be -21349932204032.0
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_2 Float32 (fp #b0 #b11110010 #b10111010111110001001100))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
