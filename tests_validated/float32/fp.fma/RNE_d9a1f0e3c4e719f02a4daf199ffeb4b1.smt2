...
(define-const input_2 Float32 (fp #b1 #b10110010 #b00101010010101100011000))
;; should be -2624197100568576.0
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float32 (fp #b1 #b00000110 #b00010001000010110100110))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
