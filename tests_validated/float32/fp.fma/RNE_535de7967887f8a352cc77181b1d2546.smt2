...
(define-const input_1 Float32 (fp #b1 #b00000000 #b00110010011011001101100))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
...
(define-const input_3 Float32 (fp #b0 #b10110000 #b00001010101000000111110))
;; should be 586318736261120.0
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
