...
(define-const input_2 Float32 (fp #b1 #b00000000 #b10100011000101000101110))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
...
(define-const input_3 Float32 (fp #b1 #b00000000 #b01010111001100010010001))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
...
(define-const expected_result Float32 (fp #b1 #b00000000 #b01010111001100010010001))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
