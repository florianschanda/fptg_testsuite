...
(define-const input_1 Float32 (fp #b0 #b00000000 #b11011001101011110110011))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
...
(define-const input_3 Float32 (fp #b0 #b10100100 #b10101111110111001111111))
;; should be 231854817280.0
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
