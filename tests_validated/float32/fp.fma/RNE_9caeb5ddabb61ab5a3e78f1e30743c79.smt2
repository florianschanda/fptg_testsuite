...
(define-const input_2 Float32 (fp #b1 #b10110010 #b11011111000101011001111))
;; should be -4214071318544384.0
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float32 (fp #b0 #b11101110 #b00111000111111000001011))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
