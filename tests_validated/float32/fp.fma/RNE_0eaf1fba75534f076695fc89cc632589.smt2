...
(define-const input_1 Float32 (fp #b0 #b00000000 #b11100100100101111110111))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
...
(define-const input_2 Float32 (fp #b1 #b10011110 #b01000010101100010110011))
;; should be -2706944768.0
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
