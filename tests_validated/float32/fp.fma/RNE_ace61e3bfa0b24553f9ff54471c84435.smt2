...
(define-const input_1 Float32 (fp #b0 #b10100011 #b01010110101100000001100))
;; should be 91989573632.0
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_2 Float32 (fp #b1 #b11101101 #b01110001110000100110110))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
