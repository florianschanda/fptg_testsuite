...
(define-const input_1 Float32 (fp #b1 #b10110001 #b01101000001000101110010))
;; should be -1583896160370688.0
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_2 Float32 (fp #b1 #b00000000 #b01100000101000100110101))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
