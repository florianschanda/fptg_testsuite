...
(define-const input_1 Float32 (fp #b1 #b10101110 #b10101110111101001011100))
;; should be -236920529485824.0
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_2 Float32 (fp #b1 #b11010110 #b00110001111111101000110))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float32 (fp #b0 #b10000100 #b10101000010100110110100))
;; should be 53.0407257080078125
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
