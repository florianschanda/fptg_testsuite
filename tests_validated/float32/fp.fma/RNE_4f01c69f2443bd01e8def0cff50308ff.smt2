...
(define-const input_1 Float32 (fp #b1 #b10100001 #b00111010111110100010100))
;; should be -21137760256.0
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float32 (fp #b1 #b00000000 #b10110010101001000101011))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
