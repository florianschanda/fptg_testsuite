...
(define-const input_1 Float32 (fp #b1 #b00000000 #b11100110100100100111101))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
...
(define-const input_3 Float32 (fp #b1 #b10100001 #b11101000000011110001101))
;; should be -32753084416.0
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
