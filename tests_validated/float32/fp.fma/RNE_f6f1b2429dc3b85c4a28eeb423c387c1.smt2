...
(define-const input_1 Float32 (fp #b1 #b10011101 #b01101011110110000000100))
;; should be -1526071808.0
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_2 Float32 (fp #b0 #b11100010 #b00111000010101111100111))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
