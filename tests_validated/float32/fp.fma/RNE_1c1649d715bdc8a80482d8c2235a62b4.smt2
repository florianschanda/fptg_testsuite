...
(define-const input_1 Float32 (fp #b1 #b10101010 #b10000000101101100101000))
;; should be -13218609102848.0
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_2 Float32 (fp #b0 #b11000110 #b10101000010110101010111))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
