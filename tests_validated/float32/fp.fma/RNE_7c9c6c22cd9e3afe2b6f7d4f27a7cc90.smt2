...
(define-const input_1 Float32 (fp #b1 #b00000000 #b00011101101000001001101))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
...
(define-const input_2 Float32 (fp #b1 #b10101100 #b10101101110001000110111))
;; should be -59066768424960.0
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
