...
(define-const input_1 Float32 (fp #b0 #b00000000 #b10010111010010111101011))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
...
(define-const input_3 Float32 (fp #b1 #b10100011 #b00100100111010111000000))
;; should be -78630092800.0
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
