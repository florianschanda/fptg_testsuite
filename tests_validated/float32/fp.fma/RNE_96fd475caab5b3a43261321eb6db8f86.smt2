...
(define-const input_2 Float32 (fp #b1 #b00000000 #b00101100010110000001010))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
...
(define-const input_3 Float32 (fp #b1 #b00000000 #b00000110110011111001001))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
...
(define-const expected_result Float32 (fp #b1 #b00000000 #b00000110110011111001001))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
