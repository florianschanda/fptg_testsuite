...
(define-const input_2 Float32 (fp #b1 #b11111010 #b01001001000010011010000))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float32 (fp #b0 #b10101111 #b10011010110001100101011))
;; should be 451651613753344.0
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
