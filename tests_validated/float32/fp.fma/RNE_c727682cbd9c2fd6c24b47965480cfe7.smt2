...
(define-const input_1 Float32 (fp #b1 #b00000000 #b11011010001100100101011))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
...
(define-const input_2 Float32 (fp #b0 #b10110100 #b10100011100111101001000))
;; should be 14764044569280512.0
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
