...
(define-const input_1 Float32 (fp #b0 #b10010000 #b11010011000000111010111))
;; should be 239111.359375
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_2 Float32 (fp #b1 #b00000000 #b01111100001000101101100))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
