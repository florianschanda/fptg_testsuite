...
(define-const input_2 Float32 (fp #b1 #b00000000 #b00000101011100010000110))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
...
(define-const input_3 Float32 (fp #b0 #b10001001 #b01010110000000011001000))
;; should be 1368.0244140625
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
