...
(define-const input_2 Float32 (fp #b0 #b00000000 #b00111010100011001011001))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
...
(define-const input_3 Float32 (fp #b0 #b00110110 #b10010001100110011111011))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float32 (fp #b0 #b00110110 #b10010001100110011111011))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
