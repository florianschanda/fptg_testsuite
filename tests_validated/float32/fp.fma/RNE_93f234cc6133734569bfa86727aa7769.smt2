...
(define-const input_1 Float32 (fp #b1 #b10010001 #b11101111000001101011001))
;; should be -506906.78125
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float32 (fp #b1 #b11011101 #b00100110100011111010001))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
