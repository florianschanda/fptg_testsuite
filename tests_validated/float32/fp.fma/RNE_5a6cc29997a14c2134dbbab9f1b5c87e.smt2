...
(define-const input_1 Float32 (fp #b1 #b10101101 #b10001000111011000010010))
;; should be -108005693587456.0
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_2 Float32 (fp #b0 #b11011100 #b11001011101011101010110))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
