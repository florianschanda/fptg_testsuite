...
(define-const input_1 Float32 (fp #b0 #b10101100 #b00101000000100111011001))
;; should be 40692504068096.0
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_2 Float32 (fp #b0 #b11110001 #b00010010011101101011011))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
