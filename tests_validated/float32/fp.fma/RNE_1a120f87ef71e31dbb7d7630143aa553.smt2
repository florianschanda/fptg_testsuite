...
(define-const input_1 Float32 (fp #b1 #b00111110 #b10110000101000101010001))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float32 (fp #b0 #b10100101 #b10010100100010111110010))
;; should be 434378440704.0
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
