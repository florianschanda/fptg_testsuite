...
(define-const input_1 Float32 (fp #b0 #b00000000 #b00010010110100011101010))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
...
(define-const input_2 Float32 (fp #b0 #b10101111 #b01101110111101101001011))
;; should be 403480334303232.0
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
