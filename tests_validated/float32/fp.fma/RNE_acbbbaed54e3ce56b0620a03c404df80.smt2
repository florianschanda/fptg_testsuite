...
(define-const input_2 Float32 (fp #b1 #b00000000 #b10110001000100001011110))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
...
(define-const input_3 Float32 (fp #b1 #b10100100 #b00111101000110100010001))
;; should be -170242883584.0
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
