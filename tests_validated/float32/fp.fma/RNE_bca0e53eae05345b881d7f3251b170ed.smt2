...
(define-const input_1 Float32 (fp #b1 #b00000000 #b10000111111110110010000))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
...
(define-const input_2 Float32 (fp #b1 #b10101001 #b01110000011000010000111))
;; should be -6328705089536.0
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
