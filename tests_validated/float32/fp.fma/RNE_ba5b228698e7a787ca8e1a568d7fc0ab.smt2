...
(define-const input_2 Float32 (fp #b1 #b10010000 #b11111101001001100110111))
;; should be -260684.859375
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float32 (fp #b1 #b01000011 #b00010001010011001001100))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
