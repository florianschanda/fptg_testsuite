...
(define-const input_2 Float32 (fp #b0 #b10010011 #b11100000000011001001111))
;; should be 1966281.875
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float32 (fp #b1 #b00000000 #b11000011001100101000110))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
