...
(define-const input_1 Float32 (fp #b1 #b10101101 #b11011100100010011110000))
;; should be -130989925859328.0
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_2 Float32 (fp #b0 #b00000000 #b10010011000101100100011))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
