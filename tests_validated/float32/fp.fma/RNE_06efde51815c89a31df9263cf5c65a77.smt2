...
(define-const input_1 Float32 (fp #b0 #b10100101 #b01001100000100011110101))
;; should be 356557422592.0
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_2 Float32 (fp #b1 #b11111001 #b10000111010101100001101))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
