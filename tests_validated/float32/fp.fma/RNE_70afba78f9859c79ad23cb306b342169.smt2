...
(define-const input_2 Float32 (fp #b0 #b01110101 #b00000001111111110100101))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float32 (fp #b0 #b10100100 #b00011100111101101101110))
;; should be 152989040640.0
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
