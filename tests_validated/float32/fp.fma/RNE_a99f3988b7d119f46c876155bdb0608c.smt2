...
(define-const input_1 Float32 (fp #b0 #b10101011 #b10000010011110000011010))
;; should be 26557984800768.0
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_2 Float32 (fp #b1 #b00000000 #b10110110111000011101010))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
