...
(define-const input_2 Float32 (fp #b1 #b10100010 #b00110010100100100110110))
;; should be -41147392000.0
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float32 (fp #b1 #b01000011 #b01001100001111111000011))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
