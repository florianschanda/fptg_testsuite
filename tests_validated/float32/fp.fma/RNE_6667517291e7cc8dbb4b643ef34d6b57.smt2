...
(define-const input_2 Float32 (fp #b0 #b00000000 #b01110010111001001001100))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
...
(define-const input_3 Float32 (fp #b0 #b10100010 #b00000101010000101010001))
;; should be 35065761792.0
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
