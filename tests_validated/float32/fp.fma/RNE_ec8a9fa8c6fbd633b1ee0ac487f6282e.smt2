...
(define-const input_1 Float32 (fp #b0 #b10100111 #b01100010110110110001001))
;; should be 1524093812736.0
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_2 Float32 (fp #b1 #b11110001 #b00011111100101011100010))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
