...
(define-const input_1 Float32 (fp #b0 #b00000000 #b00001000101110010001111))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
...
(define-const input_3 Float32 (fp #b1 #b10010110 #b11101111011111110110011))
;; should be -16236467.0
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
