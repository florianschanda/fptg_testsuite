...
(define-const input_2 Float32 (fp #b0 #b10011110 #b11110101110100100111110))
;; should be 4209589760.0
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float32 (fp #b1 #b10011011 #b00101000010010101011010))
;; should be -310684480.0
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
