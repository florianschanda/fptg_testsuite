...
(define-const input_1 Float32 (fp #b0 #b10110001 #b11011010111011000001000))
;; should be 2088729569132544.0
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_2 Float32 (fp #b0 #b11110101 #b11000010000100101001000))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
