...
(define-const input_1 Float32 (fp #b1 #b10001000 #b10100001110010010000110))
;; should be -835.5706787109375
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_2 Float32 (fp #b0 #b11011101 #b00011110111111110011011))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
