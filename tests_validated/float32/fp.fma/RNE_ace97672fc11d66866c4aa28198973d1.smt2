...
(define-const input_1 Float32 (fp #b0 #b10101001 #b00001101110001010110100))
;; should be 4634632519680.0
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_2 Float32 (fp #b0 #b00000000 #b00010011011100100110110))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
