...
(define-const input_1 Float32 (fp #b1 #b10101011 #b00111111110010010111110))
;; should be -21975598628864.0
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_2 Float32 (fp #b0 #b00000000 #b00000010110110111101000))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
