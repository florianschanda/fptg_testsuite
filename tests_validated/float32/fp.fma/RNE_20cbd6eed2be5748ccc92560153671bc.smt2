...
(define-const input_1 Float32 (fp #b1 #b10001001 #b01101110011000010010100))
;; should be -1465.51806640625
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_2 Float32 (fp #b1 #b00000000 #b01100111110001000000111))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
