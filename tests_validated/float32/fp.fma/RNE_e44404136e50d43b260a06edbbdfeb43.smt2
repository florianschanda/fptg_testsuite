...
(define-const input_1 Float32 (fp #b1 #b00001110 #b10001100110001110011010))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float32 (fp #b1 #b10100011 #b11010011010101110100101))
;; should be -125450887168.0
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
