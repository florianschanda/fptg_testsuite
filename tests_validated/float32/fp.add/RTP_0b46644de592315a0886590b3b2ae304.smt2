...
(define-const input_2 Float32 (fp #b1 #b10000100 #b10011011001111110100000))
;; should be -51.4058837890625
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float32 (fp #b1 #b10000100 #b10011011001111110100000))
;; should be -51.4058837890625
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
