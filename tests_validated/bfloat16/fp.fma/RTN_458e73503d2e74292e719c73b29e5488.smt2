...
(define-const input_2 (_ FloatingPoint 8 8) (fp #b1 #b01110101 #b1101110))
;; should be -0.0018157958984375
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 (_ FloatingPoint 8 8) (fp #b0 #b00111010 #b0000101))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
