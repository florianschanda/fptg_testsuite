...
(define-const input_1 Float64 (fp #b0 #b11001110110 #b0010000010111011110011111011011110000000100010101100))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_2 Float64 (fp #b0 #b11111100101 #b0001000110100101010101111011111011100010100001110010))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b1 #b00011011010 #b0000000011001110101000011011001101001111011100000111))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
