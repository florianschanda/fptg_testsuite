...
(define-const input_1 Float64 (fp #b1 #b11000001111 #b0010011011001101000000001000001100011111110010101000))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b0 #b01100001011 #b1101111100010100101010111011110000000010011100110111))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
