...
(define-const input_3 Float64 (fp #b0 #b10100001000 #b0101000010010100010000001101001110100011110100110101))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b0 #b10100001000 #b0101000010010100010000001101001110100011110100110101))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
