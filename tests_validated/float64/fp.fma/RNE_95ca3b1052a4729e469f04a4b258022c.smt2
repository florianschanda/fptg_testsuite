...
(define-const input_3 Float64 (fp #b1 #b11000010000 #b0111100011010101000110111110110011101110010100010010))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b1 #b11000010000 #b0111100011010101000110111110110011101110010100010010))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
