...
(define-const input_1 Float64 (fp #b1 #b10111001000 #b0001000000011101000010000000000011011111110100000101))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b1 #b00000000000 #b0111001110110100111110000011101000001011010011001101))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
