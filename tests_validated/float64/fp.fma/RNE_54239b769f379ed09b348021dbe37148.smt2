...
(define-const input_1 Float64 (fp #b0 #b11000110101 #b0111000101010011111101011001011010001011000001111010))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b1 #b00000000000 #b0011100101111111000010011110000010111100101101000101))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
