...
(define-const input_1 Float64 (fp #b1 #b00100110110 #b1000101000110111011111111111001000111100101000110100))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b0 #b00000000000 #b0000100001100011011110001110101110011011111101101011))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
