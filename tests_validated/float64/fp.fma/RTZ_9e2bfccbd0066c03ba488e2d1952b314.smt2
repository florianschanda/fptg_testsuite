...
(define-const input_1 Float64 (fp #b1 #b00110000001 #b0111110000110110001101111101110000010010101011110110))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b0 #b11000010010 #b0011001010001101001001101001011010111100111101000100))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
