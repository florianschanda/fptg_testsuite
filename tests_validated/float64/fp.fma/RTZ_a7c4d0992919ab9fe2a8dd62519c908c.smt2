...
(define-const input_1 Float64 (fp #b0 #b11111111010 #b0110010110100110011111101101001111000011011000001110))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_2 Float64 (fp #b0 #b10000111101 #b0000100100001000101100011010101010111000101001010101))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b0 #b10000000010 #b0011000000010001101001110001110101000111001000101001))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
