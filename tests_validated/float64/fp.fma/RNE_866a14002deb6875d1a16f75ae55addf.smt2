...
(define-const input_1 Float64 (fp #b0 #b10100001001 #b0110001100110011001000010101000101111011110111100010))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b0 #b10100001001 #b0110001100110011001000010101000101111011110111100010))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
