...
(define-const input_1 Float64 (fp #b0 #b01000001101 #b0100011011101011110010010111110011001100000000010011))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b1 #b10110010011 #b0111011110101011010001111010110111101110000011100000))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
