...
(define-const input_1 Float64 (fp #b0 #b10100000001 #b1000110110100000011000011011010010010101011010001101))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b1 #b00000000000 #b1010011000001000000001001011010110101010011110011010))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
