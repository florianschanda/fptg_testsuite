...
(define-const input_1 Float64 (fp #b0 #b01101111111 #b0110100010000010001101110100100100100111010101010010))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b1 #b00000000000 #b0101011001101000101111110110000000010001011010101010))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
