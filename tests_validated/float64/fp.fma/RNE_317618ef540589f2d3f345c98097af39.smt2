...
(define-const input_3 Float64 (fp #b0 #b00010001111 #b0110000100000111110101011011011001100010000111000010))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b0 #b00010001111 #b0110000100000111110101011011011001100010000111000010))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
