...
(define-const input_1 Float64 (fp #b0 #b11011110001 #b0010011100110101000100001011010000001100010011100100))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b1 #b00000000000 #b1011000110110110110100100101111101111001010001101111))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
