...
(define-const input_1 Float64 (fp #b1 #b10000101100 #b1010010100001110110100101101110110010010100101001100))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b0 #b00000000000 #b0011011001101100001010000011001110111011010010110110))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
