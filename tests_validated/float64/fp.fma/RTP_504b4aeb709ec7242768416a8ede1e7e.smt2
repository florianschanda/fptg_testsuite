...
(define-const input_3 Float64 (fp #b1 #b10011011100 #b1111000110010100110010010001101100101010100101110111))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b1 #b10011011100 #b1111000110010100110010010001101100101010100101110111))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
