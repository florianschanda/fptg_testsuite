...
(define-const input_1 Float64 (fp #b1 #b00010100111 #b1010110000010111111011010000101110011100101000010111))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b1 #b11100011100 #b1010110010011010011101101101100011101110000001101001))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
