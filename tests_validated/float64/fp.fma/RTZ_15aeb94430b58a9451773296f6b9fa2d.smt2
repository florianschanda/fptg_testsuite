...
(define-const input_3 Float64 (fp #b1 #b01110100000 #b1101000011000100010100110010010001010010001001111001))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b1 #b01110100000 #b1101000011000100010100110010010001010010001001111001))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
