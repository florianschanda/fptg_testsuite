...
(define-const input_1 Float64 (fp #b1 #b10111100010 #b0000111110001111110011110101011000111001101100101010))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_2 Float64 (fp #b1 #b11011100110 #b1111110100010110010001001001100000100100100001011001))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b0 #b01101101010 #b0100110101001101101110100000000001001000101110001110))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
