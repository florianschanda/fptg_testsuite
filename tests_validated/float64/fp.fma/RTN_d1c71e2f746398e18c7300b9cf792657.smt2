...
(define-const input_1 Float64 (fp #b0 #b10010001000 #b0010110000111101001001001110001000100100100010101010))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_2 Float64 (fp #b0 #b11110111011 #b1100110100111100110111100011000010100010011001110000))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b0 #b00010001111 #b1110100011000110111010110101010000100010010100100101))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
