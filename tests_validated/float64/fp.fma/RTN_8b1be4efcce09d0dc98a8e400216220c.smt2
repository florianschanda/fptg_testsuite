...
(define-const input_3 Float64 (fp #b0 #b11101001000 #b1010100101000010011110011110111011111111111000010000))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b0 #b11101001000 #b1010100101000010011110011110111011111111111000010000))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
