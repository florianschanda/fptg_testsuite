...
(define-const input_1 Float64 (fp #b1 #b00110111100 #b0110000010111000110000100110111000110011011000100111))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b0 #b00000000000 #b1010000011111111110000001001000101011001110010110010))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
