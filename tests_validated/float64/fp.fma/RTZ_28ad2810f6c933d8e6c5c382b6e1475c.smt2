...
(define-const input_1 Float64 (fp #b1 #b01000000000 #b1110101101111111010010000010001011101110101101110101))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b1 #b00000000000 #b1100011101011011010111110011011101110111101101000111))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
