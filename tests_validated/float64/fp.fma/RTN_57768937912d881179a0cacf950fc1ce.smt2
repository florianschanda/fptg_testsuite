...
(define-const input_3 Float64 (fp #b1 #b10001000011 #b1101100101010111011001000010000100000111001001100000))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b1 #b10001000011 #b1101100101010111011001000010000100000111001001100000))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
