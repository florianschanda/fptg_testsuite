...
(define-const input_1 Float64 (fp #b1 #b01111001110 #b0001111101011110100100001000010101011000111000111110))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b1 #b00000000000 #b0000000000000000000000000000000000000000000000001001))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
