...
(define-const input_1 Float64 (fp #b1 #b10101110100 #b1010101100101100010000011111001001010110001110010101))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b1 #b10110000100 #b0011010010001010110010001010000100010001011100110011))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
