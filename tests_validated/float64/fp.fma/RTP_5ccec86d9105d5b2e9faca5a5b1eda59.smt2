...
(define-const input_1 Float64 (fp #b1 #b10100110010 #b0100010101100100101101000110101111010100100100010001))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b1 #b10001110101 #b0000000111111110111001101110000010100010110011011100))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
