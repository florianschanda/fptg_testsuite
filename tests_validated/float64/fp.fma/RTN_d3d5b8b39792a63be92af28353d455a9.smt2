...
(define-const input_2 Float64 (fp #b0 #b10011011011 #b0110110110100101001000000111001000011001000001011100))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b1 #b00011011101 #b0110110110100101001000000111001000011001000001011011))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
