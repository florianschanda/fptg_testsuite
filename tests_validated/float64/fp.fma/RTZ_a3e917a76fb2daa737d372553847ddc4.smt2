...
(define-const input_1 Float64 (fp #b1 #b10010001001 #b0101010000010000011000010101100011001000010001000110))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b0 #b11100101110 #b1100111110011010011011100101001100010100010110110011))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
