...
(define-const input_3 Float64 (fp #b0 #b10110010110 #b0010010101011101100110101100011001001110101111011000))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b0 #b10110010110 #b0010010101011101100110101100011001001110101111011000))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
