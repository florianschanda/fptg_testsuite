...
(define-const input_2 Float64 (fp #b1 #b10100010111 #b0011101000010111001000100011010111011100000010110111))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b0 #b00100011001 #b0011101000010111001000100011010111011100000010110101))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
