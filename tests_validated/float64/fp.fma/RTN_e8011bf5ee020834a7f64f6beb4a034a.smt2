...
(define-const input_1 Float64 (fp #b1 #b11000000101 #b1001100010100111101000101000010101111111010110001001))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b1 #b01101011011 #b0000001001010110011100011010000010111001110110010001))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
