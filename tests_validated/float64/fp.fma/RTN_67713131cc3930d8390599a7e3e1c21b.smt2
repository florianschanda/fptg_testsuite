...
(define-const input_1 Float64 (fp #b1 #b11001111011 #b0000101110100100010100011010011111010011011101001111))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_2 Float64 (fp #b1 #b11010100110 #b0011010100010111010011100111100000100010010101001111))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b1 #b00000000000 #b1111011010111100100011010010111000010110110011110101))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
