...
(define-const input_1 Float64 (fp #b1 #b10100111011 #b0010001011001111111000011011101001101101010100100001))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b0 #b00000000000 #b1011001111101100011000101010011011011000011011011101))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
