...
(define-const input_3 Float64 (fp #b0 #b11100111001 #b1010000010111000010110110010011110001111100110101111))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b0 #b11100111001 #b1010000010111000010110110010011110001111100110101111))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
