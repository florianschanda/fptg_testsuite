...
(define-const input_1 Float64 (fp #b0 #b01010010000 #b0100110001000110101101000101011110010111011111000100))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b1 #b00000000000 #b0011101110110110100111111011000111100111010010111001))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
