...
(define-const input_1 Float64 (fp #b1 #b01111110010 #b1110001110111010110110011010111100101101001101101101))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b0 #b11000001011 #b1100010000000010111110110100101101010100000100001110))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
