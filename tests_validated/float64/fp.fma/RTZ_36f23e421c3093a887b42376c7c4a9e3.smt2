...
(define-const input_3 Float64 (fp #b1 #b01111101010 #b0111011001101011101101000000010110101011100011111100))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b1 #b01111101010 #b0111011001101011101101000000010110101011100011111100))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
