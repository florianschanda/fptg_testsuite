...
(define-const input_1 Float64 (fp #b0 #b11100011100 #b0001011001110111110011011000010010100000100010101010))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b0 #b01100011110 #b0001011001110111110011011000010010100000100010101010))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
