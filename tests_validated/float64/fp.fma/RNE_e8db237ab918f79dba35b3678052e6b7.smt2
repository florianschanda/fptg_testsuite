...
(define-const input_1 Float64 (fp #b1 #b01010010000 #b0000101111010101001100110101000010100110110000011000))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b1 #b10011111101 #b0010111000000011110011101000110011011000011010000111))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
