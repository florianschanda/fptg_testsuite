...
(define-const input_2 Float64 (fp #b0 #b01111101011 #b1000100010000001000101111001101101001001010111110010))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b1 #b00000000000 #b0000000000000000000110001000100000010001011110011010))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
