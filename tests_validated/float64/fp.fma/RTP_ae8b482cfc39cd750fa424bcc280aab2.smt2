...
(define-const input_3 Float64 (fp #b0 #b00011110010 #b1000000010111011110111100010001001000010111101111011))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b0 #b00011110010 #b1000000010111011110111100010001001000010111101111011))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
