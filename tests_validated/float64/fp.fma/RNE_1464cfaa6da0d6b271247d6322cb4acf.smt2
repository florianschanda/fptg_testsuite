...
(define-const input_2 Float64 (fp #b0 #b11100111101 #b1010010101000101100101110011101100101010110110011100))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b1 #b01100111111 #b1010010101000101100101110011101100101010110110011100))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
