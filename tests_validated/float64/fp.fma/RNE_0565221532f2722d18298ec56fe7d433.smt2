...
(define-const input_1 Float64 (fp #b1 #b10101111001 #b0010001001111111010110110010011000100010010111010011))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b0 #b10111000000 #b1100010110001000101001100000111010100010000010110101))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
