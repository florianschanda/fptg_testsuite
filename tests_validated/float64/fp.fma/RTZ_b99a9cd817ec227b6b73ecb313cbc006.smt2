...
(define-const input_1 Float64 (fp #b1 #b00100010000 #b1110011100101011001100100001000111011110010101100101))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b0 #b00000000000 #b0001101101111001101110100101101100010111111011000010))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
