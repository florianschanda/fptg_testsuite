...
(define-const input_1 Float64 (fp #b1 #b11111110111 #b1011010111101110001100111000111011001111101110000010))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b1 #b00000000000 #b0101011010111001100101000110000111101000111100111100))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
