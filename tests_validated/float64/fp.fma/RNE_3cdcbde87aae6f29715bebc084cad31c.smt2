...
(define-const input_1 Float64 (fp #b0 #b00101101000 #b1111111001101010010111010011111101101101010110100110))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b1 #b00000000000 #b0100100111011010101011011100111100110011001010101101))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
