...
(define-const input_3 Float64 (fp #b1 #b11011100101 #b0010110001110001011101111001111101001010010110000100))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b1 #b11011100101 #b0010110001110001011101111001111101001010010110000100))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
