...
(define-const input_1 Float64 (fp #b1 #b10011000111 #b0000010101011110111111110011001101010100000001011101))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_2 Float64 (fp #b1 #b11101000100 #b1011111011000100111111100100111100011111110010011010))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b1 #b00000110001 #b0011010111011110000111100110000101000001001101101110))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
