...
(define-const input_1 Float64 (fp #b1 #b10000101101 #b0001001011000100111000000010111100101100111110101110))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b0 #b00000000000 #b1110001100000000111010110010100111110000000100011111))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
