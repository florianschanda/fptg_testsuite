...
(define-const input_1 Float64 (fp #b0 #b11010010011 #b0110101010010001111011000010110100101101000000011000))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b0 #b10100111001 #b1110011001101000010101111011010010001000000100101011))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
