...
(define-const input_1 Float64 (fp #b1 #b10101000100 #b0101011000010001001100111111101101000000001001010111))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b0 #b00001001010 #b0101100010100111010001001000000101100001001010111011))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
