...
(define-const input_3 Float64 (fp #b0 #b11111101010 #b1000000101111101000011001011101010110101010110101011))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b0 #b11111101010 #b1000000101111101000011001011101010110101010110101011))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
