...
(define-const input_1 Float64 (fp #b1 #b00000001110 #b0011110110100001110110101010110111001011010001010011))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b0 #b00000000000 #b1100000110100101011010111111001100001110011110101101))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
