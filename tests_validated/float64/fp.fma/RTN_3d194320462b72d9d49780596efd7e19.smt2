...
(define-const input_3 Float64 (fp #b0 #b10000110000 #b0101010110011101011101000101100111010100000110101101))
;; should be 751219453962293.625
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b0 #b10000110000 #b0101010110011101011101000101100111010100000110101101))
;; should be 751219453962293.625
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
