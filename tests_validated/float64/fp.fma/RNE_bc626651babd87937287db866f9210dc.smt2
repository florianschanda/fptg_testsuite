...
(define-const input_3 Float64 (fp #b0 #b00001011010 #b0010100000100100100101000100010111000111110001000010))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b0 #b00001011010 #b0010100000100100100101000100010111000111110001000010))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
