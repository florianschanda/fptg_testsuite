...
(define-const input_3 Float64 (fp #b1 #b11101101111 #b0111001111100000011111000100101001001010100001011001))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b1 #b11101101111 #b0111001111100000011111000100101001001010100001011001))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
