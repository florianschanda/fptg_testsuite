...
(define-const input_1 Float64 (fp #b0 #b10101110010 #b0001000010011010000101010101111100011011010101010101))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b0 #b00000000000 #b0111101111110100110111101001011111010100101010111101))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
