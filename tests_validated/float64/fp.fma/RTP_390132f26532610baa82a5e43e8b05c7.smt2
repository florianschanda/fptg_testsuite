...
(define-const input_1 Float64 (fp #b0 #b11000111111 #b1110010010110100011111011100000100001001111010011011))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b0 #b00000000000 #b1010001111011000100101010110000011101001101111111110))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
