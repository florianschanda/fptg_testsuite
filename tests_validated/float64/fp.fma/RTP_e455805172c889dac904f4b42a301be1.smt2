...
(define-const input_1 Float64 (fp #b1 #b01011001001 #b1000100010101111100101101010001001010011101111001100))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b1 #b11011110001 #b1011000010101001010101101110101010011011110101000010))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
