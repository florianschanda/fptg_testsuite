...
(define-const input_2 Float64 (fp #b1 #b01111100110 #b0000100001000001101110011101010111011000010101101110))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b0 #b00000000000 #b0000000000000000000000001000010000100000110111001110))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
