...
(define-const input_1 Float64 (fp #b0 #b10101000111 #b1100000001011111110000011101110001100110100111111110))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b0 #b01011110011 #b0101100001010000000100111100101111110000101000001111))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
