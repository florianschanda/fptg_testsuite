...
(define-const input_1 Float64 (fp #b1 #b11010000100 #b1000100000111010111110100010100110010101000100001111))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b1 #b00000000000 #b1100001100101000010101011110111001010101111010100011))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
