...
(define-const input_1 Float64 (fp #b0 #b00011010000 #b0000011000110110000010000011010101001000110011011000))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b1 #b00000000000 #b0001100010011010110001000010011000101001110100100100))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
