...
(define-const input_1 Float64 (fp #b0 #b10000110011 #b1001101111010001111100001011011111000100010111000110))
;; should be 7244815452095942.0
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b1 #b01000001110 #b0110101110000101110110000111100000110001110011111000))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
