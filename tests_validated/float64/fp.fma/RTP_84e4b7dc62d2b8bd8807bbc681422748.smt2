...
(define-const input_1 Float64 (fp #b0 #b00111001100 #b0000010111001000100101100101100101000001000111111101))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b1 #b01011111011 #b0110110010011001011100010111101101011011010101010001))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
