...
(define-const input_1 Float64 (fp #b1 #b01010000011 #b1110101100001000001100100111111111011111001000000100))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b1 #b10100101011 #b0110001001110110101111101010010011100011010000010101))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
