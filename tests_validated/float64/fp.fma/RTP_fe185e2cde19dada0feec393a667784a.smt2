...
(define-const input_3 Float64 (fp #b1 #b10111000011 #b0100111011000110101110010101101100100111110110011001))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b1 #b10111000011 #b0100111011000110101110010101101100100111110110011001))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
