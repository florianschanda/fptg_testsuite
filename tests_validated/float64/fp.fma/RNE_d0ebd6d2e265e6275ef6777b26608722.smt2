...
(define-const input_1 Float64 (fp #b1 #b10100000110 #b0110011010100111001101001001110111000010111100001011))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b0 #b00000000000 #b1001101000000111101000011011011111010111110101010011))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
