...
(define-const input_3 Float64 (fp #b0 #b10000100010 #b0100000010011010010011110101011010101011000101101101))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b0 #b10000100010 #b0100000010011010010011110101011010101011000101101101))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
