...
(define-const input_1 Float64 (fp #b0 #b11010100101 #b0100100111111100011101110001110100000010010110011110))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b1 #b00000000000 #b0000100110010111110110010010110000001010000010100000))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
