...
(define-const input_1 Float64 (fp #b0 #b10111011011 #b0110011100100100110000111010011011110011001111111111))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_3 Float64 (fp #b1 #b00000000000 #b1001111000000100000100110011011101111110111001000010))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
