...
(define-const input_2 Float64 (fp #b0 #b10000011000 #b0100111110010101011101000100011010011010110001110001))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b1 #b00000011010 #b0100111110010101011101000100011010011010110001110001))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
