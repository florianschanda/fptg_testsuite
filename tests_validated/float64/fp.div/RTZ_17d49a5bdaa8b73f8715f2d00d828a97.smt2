...
(define-const input_1 Float64 (fp #b1 #b10000001010 #b1010001110011100000110111111011101000100000011001011))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_2 Float64 (fp #b1 #b00000000000 #b0110101110101101010100011101101011101110011101100111))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
