...
(define-const input_2 Float64 (fp #b1 #b00100011110 #b0110000010111111100110001000101100110000001011110001))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b0 #b01011100001 #b0111001110010010110101110100101110111111111111010001))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
