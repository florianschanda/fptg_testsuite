...
(define-const input_1 Float64 (fp #b0 #b10111111001 #b1001101000101101000010100100010100100001100100011010))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_2 Float64 (fp #b0 #b00100110000 #b1101010001101100111100010000011111011100010101011110))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
