...
(define-const input_1 Float64 (fp #b1 #b00110101100 #b0110011111010101100100000110100001100110010000100111))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b0 #b10110101010 #b0110011111010101100100000110100001100110010000101000))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
