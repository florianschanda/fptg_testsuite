...
(define-const input_1 Float64 (fp #b0 #b11000000111 #b1011100000010101100011100001000100000000100011001100))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const input_2 Float64 (fp #b0 #b00000000000 #b1110001000011011110001110110101111110000001110110111))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
