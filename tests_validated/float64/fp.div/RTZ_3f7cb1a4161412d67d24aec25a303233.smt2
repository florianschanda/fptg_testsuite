...
(define-const input_2 Float64 (fp #b1 #b01001110000 #b1001111010101111101100011011010000001101100011110011))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b0 #b00110001111 #b0011110000010011001101110101000101011111001001100100))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
