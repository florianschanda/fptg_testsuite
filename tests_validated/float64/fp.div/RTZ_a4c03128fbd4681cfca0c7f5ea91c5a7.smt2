...
(define-const input_2 Float64 (fp #b0 #b00100110111 #b1111001010111110001000010100000010001111011100001011))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b1 #b01011001000 #b0000011011001110000010101100001111110001110100101001))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
