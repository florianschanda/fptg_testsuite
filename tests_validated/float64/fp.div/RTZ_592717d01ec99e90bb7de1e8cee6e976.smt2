...
(define-const input_1 Float64 (fp #b1 #b01101101100 #b0010101100100101000001011111010110011101011111001000))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b1 #b11101101010 #b0010101100100101000001011111010110011101011111001000))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
