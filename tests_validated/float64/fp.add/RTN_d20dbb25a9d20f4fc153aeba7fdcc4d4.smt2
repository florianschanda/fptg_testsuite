...
(define-const input_2 Float64 (fp #b1 #b00000000000 #b1111010011001110111001000010010010000010010010110000))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b1 #b00000000001 #b1111010011001110111001000010010010000010010010110000))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
