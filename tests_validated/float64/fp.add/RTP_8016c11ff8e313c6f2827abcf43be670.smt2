...
(define-const input_1 Float64 (fp #b1 #b11001010001 #b0010011100000101100011011110101111011101110110101111))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b1 #b11001010001 #b0010011100000101100011011110101111011101110110101110))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
