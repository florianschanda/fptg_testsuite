...
(define-const input_1 Float64 (fp #b1 #b11000100100 #b0110011101000011110110101001100110101100111101010000))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b1 #b11000100100 #b0110011101000011110110101001100110101100111101001111))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
