...
(define-const input_2 Float64 (fp #b1 #b00000000000 #b1000011100001000000110110110100100101000110001001111))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b1 #b00000000001 #b1000011100001000000110110110100100101000110001001111))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
