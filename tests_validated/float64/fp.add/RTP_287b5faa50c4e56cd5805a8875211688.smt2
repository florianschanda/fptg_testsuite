...
(define-const input_2 Float64 (fp #b0 #b11100010110 #b1010110110001011110100111101111010110111110010110100))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b0 #b11100010110 #b1010110110001011110100111101111010110111110010110100))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
