...
(define-const input_1 Float64 (fp #b0 #b11010101110 #b0001001111111111110100001110110001011101111001111010))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b0 #b11010101110 #b0001001111111111110100001110110001011101111001111010))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
