...
(define-const input_2 Float64 (fp #b0 #b10010011111 #b0111110100110100001101010011011101101110001110001000))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b0 #b10010011111 #b0111110100110100001101010011011101101110001110000111))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
