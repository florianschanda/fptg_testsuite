...
(define-const input_1 Float64 (fp #b0 #b10100100110 #b0110100001000010110101100100100010001101111100111100))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b0 #b10100100110 #b0110100001000010110101100100100010001101111100111011))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
