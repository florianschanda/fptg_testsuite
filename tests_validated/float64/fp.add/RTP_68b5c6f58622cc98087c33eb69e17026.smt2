...
(define-const input_1 Float64 (fp #b0 #b10001100100 #b0100011001110011001001001010101100110111111010010101))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b0 #b10001100100 #b0100011001110011001001001010101100110111111010010110))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
