...
(define-const input_2 Float64 (fp #b0 #b11011001011 #b1010001011001110010101110111110110011011101000110110))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b0 #b11011001011 #b1010001011001110010101110111110110011011101000110110))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
