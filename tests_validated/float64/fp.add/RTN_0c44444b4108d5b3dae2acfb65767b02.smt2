...
(define-const input_2 Float64 (fp #b0 #b00000000000 #b1001100000000000110011101110000111101010110100100011))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b1 #b00000000000 #b0110011111111111001100010001111000010101001011011100))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
