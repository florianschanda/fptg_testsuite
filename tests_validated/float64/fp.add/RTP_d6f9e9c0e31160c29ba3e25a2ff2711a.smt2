...
(define-const input_1 Float64 (fp #b1 #b01011111010 #b1101010001001011110101001011001011001111000010010101))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b1 #b01011111010 #b1101010001001011110101001011001011001111000010010100))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
