...
(define-const input_2 Float64 (fp #b1 #b10111011000 #b0001110011101111101100001100010111110011110000001001))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b1 #b10111011000 #b0001110011101111101100001100010111110011110000001010))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
