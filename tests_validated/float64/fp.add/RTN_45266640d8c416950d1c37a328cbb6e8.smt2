...
(define-const input_1 Float64 (fp #b0 #b10100000111 #b1010000100110100111111110110111011001010011111010110))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b0 #b10100000111 #b1010000100110100111111110110111011001010011111010110))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
