...
(define-const input_1 Float64 (fp #b1 #b11100101101 #b1111110101011001011001010110001101000101101000011010))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b1 #b11100101101 #b1111110101011001011001010110001101000101101000011010))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
