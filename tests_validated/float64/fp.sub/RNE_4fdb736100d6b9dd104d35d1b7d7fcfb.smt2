...
(define-const input_1 Float64 (fp #b0 #b00101111011 #b0100101000001111001000111110110101010100101111001010))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b0 #b00101111011 #b0100101000001111001000111110110101010100101111001010))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
