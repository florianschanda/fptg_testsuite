...
(define-const input_2 Float64 (fp #b1 #b01110000110 #b0100100010011010001000001011101011100100011011011101))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b0 #b01110000110 #b0100100010011010001000001011101011100100011011011101))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
