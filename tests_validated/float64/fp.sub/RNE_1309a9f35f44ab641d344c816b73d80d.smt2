...
(define-const input_2 Float64 (fp #b0 #b01010000100 #b1101100011101100000001010000010001110101100110001110))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b1 #b01010000100 #b1101100011101100000001010000010001110101100110001110))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
