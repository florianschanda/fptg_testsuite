...
(define-const input_1 Float64 (fp #b1 #b00001101000 #b0101011001100001110100011000110111110010110000001001))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b1 #b00001101000 #b0101011001100001110100011000110111110010110000001001))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
