...
(define-const input_1 Float64 (fp #b1 #b11100000101 #b1010001110011001101100010100110000111111001011000011))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b1 #b11100000101 #b1010001110011001101100010100110000111111001011000011))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
