...
(define-const input_2 Float64 (fp #b1 #b11101010101 #b1111100111011001000100110001011001111100111010110011))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b0 #b11101010101 #b1111100111011001000100110001011001111100111010110011))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
