...
(define-const input_2 Float64 (fp #b0 #b11111101011 #b1111101010000010111111000011001101111111101101110010))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b1 #b11111101011 #b1111101010000010111111000011001101111111101101110010))
;;   isZero      : False
;;   isSubnormal : False
;;   isNormal    : True
;;   isInfinite  : False
