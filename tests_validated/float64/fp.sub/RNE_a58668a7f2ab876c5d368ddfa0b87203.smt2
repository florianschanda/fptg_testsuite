...
(define-const input_2 Float64 (fp #b1 #b00000000000 #b1000110100101101110001000001001000100000010001110010))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
...
(define-const expected_result Float64 (fp #b1 #b00000000000 #b0111001011010010001110111110110111011111101110001101))
;;   isZero      : False
;;   isSubnormal : True
;;   isNormal    : False
;;   isInfinite  : False
